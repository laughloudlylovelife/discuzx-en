...
/*vot*/			$query = DB::query("SELECT mp.*, mvi.field, m.uid, m.username, m.groupid, m.email, m.regdate, ms.regip, v.message, v.submittimes, v.submitdate, v.moddate, v.admin, v.remark, v.uid as vuid
