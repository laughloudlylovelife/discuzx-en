...
//utility/update.php
	...
	'ucenter160update'		=> 'الرجاء ترقية  UCenter الخاص بك الى الاصدار  1.6.0 او احدث.<br>اذا كنت تستعمل Discuz!X مع UCenter, الرجاء ترقية  UCenter باستخدام uc_server/upgrade/upgrade3.php',//'请先升级UCenter到1.6.0以上版本。<br>如果使用为Discuz! X自带UCenter，请先运行uc_server/upgrade/upgrade3.php进行升级',
	...
	'check_plugins'			=> 'بعد الترقية بنجاح, اغلق كل الهاكات ليعمل ديسكاز بالشكل الصحيح. بعد ذلك قم بفتح هاك تلو الاخر لمعرفة ان كان هناك خطأ في احداها بأن تقوم بترقيته لتوافق مع اصدار ديسكاز الحالي .',//'升级完成后会关闭所有插件以确保正常运行，请站长逐个开启每一个插件检测是否兼容新版本。',
	...
	'db_structure_upgraded'		=> 'تم ترقية بنية قاعدة البيانات بنجاح, اضغط هنا لترقية باقي البيانات',//'数据库结构升级完毕,进入下一步数据升级操作',
...
//	'sql_error'			=> ' Error. Please perform the following update statement by hand, then re-run the upgrade program',//'出错,请手工执行以下升级语句后,再重新运行本升级程序',
	...
	'table_rename'			=> 'تغيير اسم جدول  ',//'表改名 ',
	'sql_statement'			=> 'جملة ترقية  SQL ',//'升级SQL语句',
	'check_table'			=> 'افحص جدول ',//'检查表 ',
	'skip_table'			=> ' تم بنجاح, بدون ترقية, تجاوز',//' 完成,不需升级,跳过',
	'real_names_updated'		=> 'تم ترقية الاسم',//'实名功能升级完毕',
	'real_name'			=> 'الاسم الحقيقي',//'真实姓名',
	'real_name_progress'		=> 'عملية ترقية الاسماء الحقيقية:',//'实名功能升级中',
	'users_updated'			=> 'عملية ترقية اسماء الاعضاء تمت بنجاح',//'用户栏目升级完毕',
	'recommended_webmaster'		=> 'مستحسن من قبل الادارة',//'站长推荐',
	'article_tags'			=>  array (
					    1 => 'أصلي',//'原创',
					    2 => 'نشط',//'热点',
					    3 => 'صور',//'组图',
	...
	'settings_updated'		=> 'تهانيناً, تم ترقية الاعدادات بنجاح',//'配置项升级完成',
	'group_setting_updated'		=> 'تم ترقية اعدادات المجموعات بنجاح',//'管理组设置升级完成',
	'clean_feeds'			=> 'مسح الاخبار التالفة',//'清理过期动态',
	'cron_completed'		=> 'تم ترقية مهام Cron بنجاح',//'计划任务升级完成',
	'color_card'			=> 'بطاقة الالوان',//'变色卡',
	'color_card_descr'		=> 'يمكنك تغيير لون او تنسيق عنوان موضوع معين',//'可以将帖子或日志的标题高亮，变更颜色',
	...
	'anonymous_card_descr'		=> 'اظهار اسمك كمخفي في المواقع المميزة.',//'在指定的地方，让自己的名字显示为匿名。',
	...
	'users_completed'		=> 'تم ترقية الاعضاء بنجاح',//'用户升级完毕',
	...
	'realname_verify'		=> 'مراجعة الاسم الحقيقي',//'实名认证升级中',
	'video_verify'			=> 'مراجعة الفيديو',//'视频认证',
	'real_name_verification'	=> 'مراجعة الاسم الحقيقي',//'实名认证升级中',
	...
	'config_not_writable'		=> '"config/config_global.php" تم ترقيته بنجاح, لا يمكن الكتابة على مجلد  "config/" , لقد قمنا بحفظ الملف الذي قمنا بترقيته في  "data/" , الرجاء انقل هذا الملف الى هذا المجلد "config/" ووافق على الاستبدال ان وجد.',//'"config/config_global.php" 文件已更新,由于 "config/" 目录不可写入,我们已将更新的文件保存到 "data/" 目录下,请通过 FTP 软件将其转移到 "config/" 目录下覆盖源文件.',
	'config_continue'		=> 'بعد اكمال هذه العملية انقر هنا للإستمرار',//'当您完成上述操作后点击这里继续',
	...
	'tables_fields_no_unused'	=> 'تمت المقارنة مع قاعدة البيانات الاصلية, لا يوجد جداول اضافية او حقول اضافية.',//'与标准数据库相比,没有需要删除的数据表和字段',
	...
	'yes'				=> 'نعم',//'是',
	'no'				=> 'لا',//'否',
	'default_style_restored'	=> 'تم استعادة الاستايل الافتراضي, الذهاب للمرحلة الاخرى',//'默认风格已恢复,进入下一步',
