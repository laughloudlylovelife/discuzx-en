...
/*vot*/		@unlink($cachedir.'/'.$tidmd5[0].'/'.$tidmd5[1].'/'.$tidmd5[2].'/'. DISCUZ_LANG . '_0.htm');
	}
...
/*vot*/	$output = array('str'=>array(), 'preg' => array()); //str for subdomains to find and replace, preg for search and replace the default domain name
	$_G['domain'] = array();
