================================================
upgrade SupeSite 7.5 to Discuz! X1.5 description
================================================

Special Alert!!!
Discuz! X1.5 does not have all of the features of SupeSite 7.5,
This conversion process, only the information in the conversion SupeSite 7.5 classification of news articles data to Discuz! X1.5 products, the article system.
Other data will not be converted.
Therefore, data conversion, Discuz! X1.5 products that are lost and the original data loss SupeSite feature, please weigh the decision whether to convert to upgrade themselves.
...
3. upload the files from Discuz! X1.5 upload directory to SupeSite directory
4. Run the installer /install/
   Please specify the original installation where SupeSite mounted the UCenter Server

II upgrade SupeSite Data
------------------------
1. Install and test the Discuz! X1.5 works normal. After this upload the Discuz! X1.5 convert/ directory to root directory
2. Execute /convert
...
--------------------------------------------------------------
1. Edit the new Discuz! X1.5 config/config_global.php file, and set the founder ID
2. Direct access to the new Discuz! X1.5 admin.php
...
5. Move the old attachments directory (without moving, your posts will not be able to find any attachments)
   a) Move the old/attachments directory files the new Discuz! X1.5 /data/attachment/portal/ directory
   b) find the original SS7 icon images/base/attachment.gif, and move it to Disucuz! X1.5 static/image/filetype/ directory;
...
6. Move old image directory to the root directory of new product (before the transfer, the information content in your face does not display)
   a) Move the old/images directory to a new Discuz! X1.5 root directory
