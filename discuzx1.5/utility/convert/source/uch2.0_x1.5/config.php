...
if(submitcheck()) {
	...
	show_form_header();
	show_table_header();
	show_table_row(array(array('colspan="3"', lang('update','config_usergroup'))), 'header title');
	show_table_row(
		array(
			lang('update','config_from_usergroup'),
			array('class="bg1" width="10%" align="center"', '->'),
			lang('update','config_target_usergroup')
		)
	);
	...
	show_table_header();
	show_table_row(array(array('colspan="3"', lang('update','config_extcredits'))), 'header title');
	show_table_row(
		array(
			lang('update','config_from_credit'),
			array('class="bg1" width="10%" align="center"', '->'),
			lang('update','config_target_credit')
		)
	);
	show_table_row(
		array(
			array('class="bg2" width="45%"', lang('update','config_credit')),
			array('class="bg1" width="10%" align="center"', '->'),
	...
	show_table_row(
		array(
			array('class="bg2" width="45%"', lang('update','config_experience')),
			array('class="bg1" width="10%" align="center"', '->'),
	...
	show_table_header();
	show_table_row(array(array('colspan="3"', lang('update','config_convert_forum'))), 'header title');
	show_table_row(
		array(
			lang('update','config_from_data'),
			array('class="bg1" width="10%" align="center"', '->'),
			lang('update','config_target_forum')
		)
	);
	show_table_row(
		array(
			array('class="bg2" width="45%"', lang('update','config_poll')),
			array('class="bg1" width="10%" align="center"', '->'),
			array('class="bg2" width="45%"', '<select name="forum[poll]"><option value="0" selected>'.lang('update','config_auto_create').'</option>'.$forumoption.'</select>')
		),'bg1'
	);
	show_table_row(
		array(
			array('class="bg2" width="45%"', lang('update','config_event')),
			array('class="bg1" width="10%" align="center"', '->'),
			array('class="bg2" width="45%"', '<select name="forum[event]"><option value="0" selected>'.lang('update','config_auto_create').'</option>'.$forumoption.'</select>')
		),'bg1'
	);
	show_table_footer();
