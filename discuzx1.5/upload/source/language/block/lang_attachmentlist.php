...
(
	...
	'attachmentlist_isimage'		=> 'Attach type',//'附件类型',
	'attachmentlist_isimage_comment'	=> 'Set the type of attachment',//'设置调用的附件类型',
	'attachmentlist_isimage_0'		=> 'All',//'全部附件',
	'attachmentlist_isimage_1'		=> 'Image',//'图片附件',
	'attachmentlist_isimage_2'		=> 'General file',//'普通附件',
	...
	'attachmentlist_threadmethod'		=> 'Thread Mode',//'主题方式调用',
	'attachmentlist_threadmethod_comment'	=> 'Select &quot;Yes&quot; to show attachment in thread mode (each thread display one attachment), or &quot;No&quot; to show attachments in attachment mode.',//'选择“是”将按照主题方式调用附件，一个主题显示一个附件；选择“否”将按照附件方式调用'/'选择“是”将按照主题方式调用附件，一个主题显示一个附件；选择“否”将按照附件方式调用',
	...
	'attachmentlist_orderby'		=> 'Order by',//'附件排序方式',
	'attachmentlist_orderby_comment'	=> 'Set the ordering of attachments',//'设置以哪一字段或方式对附件进行排序',
	'attachmentlist_orderby_dateline'	=> 'Attach time',//'按最后更新日期排序',
	'attachmentlist_orderby_downloads'	=> 'Downloads',//'按下载次数倒序排序',
	'attachmentlist_orderby_hourdownloads'	=> 'Downloads in hours',//'按小时下载次数倒序排序',
	'attachmentlist_orderby_todaydownloads'	=> 'Downloads today',//'按当天下载次数倒序排序',
	'attachmentlist_orderby_weekdownloads'	=> 'Downloads last week',//'按本周下载次数倒序排序',
	'attachmentlist_orderby_monthdownloads'	=> 'Downloads last month',//'按当月下载次数倒序排序',
