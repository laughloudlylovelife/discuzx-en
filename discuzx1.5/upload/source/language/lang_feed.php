...
(
	...
	'feed_doing_title'	=> '{actor} twit: {message}',//'{actor}：{message}',
	...
	'feed_thread_goods_message_2'	=> '<b>{itemname}</b><br />Price: {itemprice} dollars(???)',//'<b>{itemname}</b><br />售价 {itemprice} 元',
	...
	'feed_reply_activity_title'	=>		'{actor} enrolled in the activities of {subject}',//'{actor} 报名参加了 {subject} 的活动',
