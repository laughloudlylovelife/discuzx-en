...
//vot 2 vars for language select:
	'welcome'		=> 'Welcome to Discuz! X1.5 Installation!',
...
//
	...
	'short_open_tag_invalid'	=> 'Sorry, please set the <b>short_open_tag</b> to <b>On</b> in php.ini, otherwise installation can not be continued.',//'对不起，请将 php.ini 中的 short_open_tag 设置为 On，否则无法继续安装。',
	...
	'install_founder_contact'	=> 'Go to the next step - Set contacts',//'进入下一步填写联系方式',

	'init_credits_karma'	=> 'Rating',//'威望',//!!! The same in install_var.php
	'init_credits_money'	=> 'Money',//'金钱',//!!! The same in install_var.php

	'init_postno0'		=> 'Landlord',//'楼主',//!!! The same in install_var.php 
	'init_postno1'		=> 'Sofa',//'沙发',    //!!! The same in install_var.php
	'init_postno2'		=> 'Bench',//'板凳',   //!!! The same in install_var.php
	'init_postno3'		=> 'Floor',//'地板',   //!!! The same in install_var.php
	...
	'license'	=> '<div class="license"><h1>Chinese version of license agreement applies to Chinese users</h1>
			...
			<li>Sing Imagination (Beijing) Technology Co., Ltd. does not use the software to build the forum information in the article or responsibility.</Li>
			</ol>

			<p>The Discuz! end user license agreement, business license and technical services to the details by Discuz! official website exclusive. Sing Imagination (Beijing) Technology Co., Ltd. has, without prior notice, modify the license agreement and the power of service price list, the revised agreement or change list from the date of the new authorized user effect.</p>

			<p>Electronic text form of license agreement as the two sides signed the agreement in writing as a complete and equivalent legal effect. Once you start the installation Discuz!, Shall be deemed to fully understand and accept the terms of this Agreement, in the enjoyment of the powers conferred by these provisions, while subject to restrictions and limitations related. Licensing agreement outside the scope of actions that directly violate the licensing agreement and constitutes infringement, we have the right to terminate the authorization, shall be ordered to stop the damage, and retains the investigation related to the power of responsibility.</p></div>',
...
'install_region_data'		=> 'Install regional data',//'Install regional data',
	...
	'founder_contact'	=> '<h4>About the "Hong Sing Improvement Program" description </ h4>
		<p>
		In order to continuously improve the product quality, improve the user experience,

		the Discuz! X "Hong Sing Improvement Program" system helps us to analyze the

		operation of the forum users habits, and thus help us in future versions

		of the product improvements, design more Users demand new features.
		</p>
		<p>
		The system does not collect sensitive information,
		the site does not collect user information,
		there is no security risk, and after the actual test will not affect
		the efficiency of the forum.
		</p>
		<p>
		Using this version to install, you agree to join the
		"Hong Sing Improvement Program", and Discuz! Operations analysis will be
		installed on your site to provide operational guidance for your suggestion,
		we will prompt you how to open the forum site operation functions,
		how reasonable function configuration, and to provide some other operating
		experience.
		</p>
		<p>
		In order to facilitate communication between us and you to operating strategy,
		please leave a commonly used network contact
		</p>',

	'skip_current'		=> 'Skip this step',//'跳过本步',
	'topic'			=> 'Topic',//'专题',

	'step_show_license_title'	=> 'License agreement',//'中文版授权协议 适用于中文用户',
	'step_show_license_desc'	=> '',
