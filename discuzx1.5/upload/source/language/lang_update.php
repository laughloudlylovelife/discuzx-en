...
//convert/include/global.func.php
	...
	'pm'	=> ' PM ',//'下午',
	'prompt'		=> 'Prompt',//'系统提示',
	'dzx_update'		=> 'Discuz! X series products upgrade conversion',//'Discuz! X 系列产品升级转换',
	'dzx_update_wizard'	=> 'Discuz! X Series product upgrade / conversion wizard',//'Discuz! X 系列产品升级/转换 向导',
	'step1'		=> '1. Select the conversion process',//'1.选择产品转换程序',
	'step2'		=> '2. Set up the server information',//'2.设置服务器信息',
	'step3'		=> '3. Configure the conversion process',//'3.配置转换过程',
	'step4'		=> '4. Perform the data conversion',//'4.执行数据转换',
	'step5'		=> '5. Conversion is complete',//'5.转换完成',
...
//	'done'			=> 'Done!',//'完成！',
	...
	'stamps_completed'		=> 'Thread Icons upgrade is completed',//'鉴定图章升级完毕',
