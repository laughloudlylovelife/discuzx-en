 ...
 *
 *      $Id: admincp_members.php 21369 2011-03-24 03:27:53Z svn_project_zhangjie $
...
/*vot*/	$member['regdate'] = dgmdate($member['regdate'], 'Y-m-d h:i');
/*vot*/	$member['lastvisit'] = dgmdate($member['lastvisit'], 'Y-m-d h:i');
