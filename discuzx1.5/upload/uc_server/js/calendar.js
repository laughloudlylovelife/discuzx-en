...
function loadcalendar() {
	...
	s += '<th><a href="###" onclick="refreshcalendar(yy, mm-1)" title="Prev Month">&laquo;</a></th>';
	s += '<th colspan="5" style="text-align: center"><a href="###" onclick="showdiv(\'year\');_cancelBubble(event)" title="Click to Select Year" id="year"></a>&nbsp; - &nbsp;<a id="month" title="Click to Select Month" href="###" onclick="showdiv(\'month\');_cancelBubble(event)"></a></th>';
	s += '<th><A href="###" onclick="refreshcalendar(yy, mm+1)" title="Next Month">&raquo;</A></th>';
	s += '</tr>';
	...
	for(var k = 1; k <= 12; k++) {
		s += '<a href="###" onclick="refreshcalendar(yy, ' + (k - 1) + ');$(\'calendar_month\').style.display=\'none\'; "><span' + (today.getMonth()+1 == k ? ' class="bold"' : '') + ' id="calendar_month_' + k + '">' + k + ( k < 10 ? '&nbsp;' : '') + ' </span></a><br />';
	}
