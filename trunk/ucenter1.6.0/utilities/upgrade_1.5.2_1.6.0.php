...
ALTER TABLE uc_applications CHANGE name name varchar(64) NOT NULL default '';
...
<tr>
<td align="center">
<b>The upgrade process can only upgrade from $version_old to $version_new , Before Run, make sure all files have been uploaded, and data backup is made<br />
