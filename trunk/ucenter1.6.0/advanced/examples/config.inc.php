...
define('UC_IP', '');					// UCenter IP, set this value when UC_CONNECT is non-mysql manner, and the current application server, there is a problem resolving the domain name
