====================================
UCenter Home 2.0 Upgrade to Discuz! X1.0 Help
====================================
...
- Personal data of the new adjustments,
  UCH of the original profile of the school, work,
  information will need to fill out;
...
4. The conversion process is not without interruption, until the program
...
5. Transfer the old attachments directory to the root directory of new products
   ...
   b) Move all the files to the new Discuz! X product /data/attachment/album/
      directory
   c) the same time, change it Discuz! X code
	 ...
	 $findarr = array(
		...
		$bbs_url.'attachments/month',  // original forum attached images directory
	 );
	 $replacearr = array(
	 ...
	 $blog['message'] = str_replace($findarr, $replacearr, $blog['message']);
      ...
      Fix the above code
        <img src="attachment/  
      to attachment in the attachment to your own directory name
...
7. Recovery space.php URL address of the visit (before the restoration of your
   information on the dynamic of the station can not access the link will point to
   the address)
