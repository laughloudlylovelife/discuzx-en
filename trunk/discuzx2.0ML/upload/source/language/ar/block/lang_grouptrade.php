...
(
	...
	'grouptrade_fids_comment'	=> 'استخدام "," للفصل بين ارقام المجموعات',//'设置允许参与新帖调用的群组，可以按住 CTRL 多选，全选或全不选均为不做限制',
	'grouptrade_gtids'		=> 'اقسام المجموعة',//'群组分类',
	'grouptrade_gtids_comment'	=> 'Set the category of group, use CTRL to select groups',//'设置群组所在分类，可以按住 CTRL 多选，全选或全不选均为不做限制',
	'grouptrade_uids'		=> 'ارقام الاعضاء',//'用户UID',
	'grouptrade_uids_comment'	=> 'استخدم الفاصلة للفصل بين المتعدد.',//'设置要指定显示的用户UID，多个UID请用半角逗号“,”隔开。',
	'grouptrade_startrow'		=> 'صف البدء',//'起始数据行数',
	'grouptrade_startrow_comment'	=> 'If you need to set start row, please enter a number,0 هو اول صف',//'如需设定起始的数据行数，请输入具体数值，0 为从第一行开始，以此类推',
	...
	'grouptrade_sortids'		=> 'ارقام الترتيب(الاقسام?)',//'分类信息',
	...
	'grouptrade_sortids_all'	=> 'كل الاقسام',//'全部的分类信息',
	...
	'grouptrade_special_1'		=> 'موضوع استطلاع',//'投票主题',
	...
	'grouptrade_orderby_lastpost'	=> 'اخر مشاركة',//'按最后回复时间倒序排序',
	...
	'grouptrade_orderby_weekexp'	=> 'انتهى منذ اسبوع',//'按一周内报名截止时间排序',
	'grouptrade_orderby_monthexp'	=> 'انتهى منذ شهر',//'按一月内报名截止时间排序',
	'grouptrade_gviewperm'			=> 'عرض صلاحيات المجموعة',//'群组浏览权限',
	'grouptrade_gviewperm_nolimit'	=> 'غير محدد',
	'grouptrade_gviewperm_only_member'	=> 'الاعضاء فقط',//'仅成员',
