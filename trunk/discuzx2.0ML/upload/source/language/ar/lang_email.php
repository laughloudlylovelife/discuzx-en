...
(
	...
	'get_passwd_message'	=> '
<p>{username},
هذه الرسالة تم ارسالها من {bbname}.</p>

<p>انت استقبلت الرسالة , لان هذا البريد هو البريد الذي سجلت به في المنتدى,
وطلب اعادة تعيين كلمة المرور.</p>
<p>
----------------------------------------------------------------------<br />
<strong>هام!</strong><br />
----------------------------------------------------------------------</p>
<p>اذا لم تطلب ارجاع كلمة المرور او التذكير بها او انك غير مسجل بالمنتدى,
...
<p>بعد فتح الرابط, اكتب كلمة المرور الجديدة , ثم يمكنك استخدام كلمة المرور الجدية اثناء تسجيل الدخول.
يمكنك تغيير كلمة المرور من لوحة تحكم العضو بأي وقت من الاوقات.</p>

<p>طلب استرجاع كلمة المرور جاء من الاي بي التالي: {clientip}</p>
...
{siteurl}</p>',
	...
	'email_verify_subject'	=> 'تفعيل البريد الالكتروني',//'Email 地址验证',
	'email_verify_message'	=> '
<p>{username},
تم ارسال لك الرسالة من  {bbname}.</p>
<p>انت استقبلت هذه الرسالة, بسبب الاعضاء الجدد بالمنتدى,
او عضو استخدم بريدك.
اذا لم تزر منتدانا, او غير مهتم ,
...
<p>انت عضو جديد في منتدانا, او قد عدلت بريدك الالكتروني,
نحن يجب علينا ان نتحقق من البريد الالكتروني الخاص بك.</p>

<p>لتفعيل بريدك الالكتروني الرجاء الضغط على الرابط ادناه:<br />

<a href="{url}" target="_blank">{url}</a>
<br />
(اذا لم يعمل الرابط اعلاه, الرجاء نسخه ولصقه في شريط العناوين الخاص بالمتصفح .)</p>

<p>شكرا لزيارتك وأتمنى أن تكون سعيدا! </p>
...
{siteurl}</p>',
	...
	'add_member_message'	=> '
{newusername},
هذه الرسالة تم ارسالها من  {bbname}.

انا {adminusername}, اداري في منتدى  {bbname}. انت استقبلت هذه ا لرسالة بسببانضمامك عضو لدينا
...
من الآن، يمكنك استخدام الحساب لتسجيل الدخول إلى منتدانا، وأتمنى لكم طيب للاستخدام!
...
{siteurl}',
	...
	'birthday_message'	=> '
{username},
تم ارسال هذه الرسالة من  {bbname}.

انت استقبلت هذه الرسالة, لان هذا البريد مسجل لدى سجلات منتدانا.
...
ملاحظة
اذا لم تكن عضوا في منتدانا, او اليوم هو ليس عيد ميلادك,
ربما هناك خطأ.
الرجاء تفحص بريدك وتاريخ ميلادك.
هذه الرسالةسوف لا يتم ارسالها الى هذا البريد,  الرجاء تجاهل هذه الرسالة .
...
انت استقبلت هذه الرسالة بسبب  {$_G[member][username]} من  {$_G[setting][bbname]}
اضغط على "ارسال الى صديق" لشيئ مستحسن لك .
...
هذه الرسالة تم ارسلها بواسطة صديق لك بمنتدانا  "رسالة الى صديق" !
ادارة المنتدى ليس لها علاقه بهذه الرسالة.
...
$sendtoname,
تم ارسال هذه الرسالة بواسطة {$_G[member][username]} من  {$_G[setting][bbname]}.

انت استقبلت هذه الرسالة بسبب العضو  {$_G[member][username]}
...
ولا علاقة ادارة المنتدى بهذه الرسالة.
...
<p>تم القبول: لقد تمت الموافقة على التسجيل , اصبحت الان عضوا رسميا في منتدانا.</p>
...
{siteurl}',
	...
	'adv_expiration_subject' =>	'سوف تكون مدة الاعلان في موقعك  {day} يوم, يرجى الاتفاق',
	'adv_expiration_message' =>	'الاعلان التالي على موقعك سينتهي خلال {day} يوم, الرجاء الاتفاق:<br /><br />{advs}',
