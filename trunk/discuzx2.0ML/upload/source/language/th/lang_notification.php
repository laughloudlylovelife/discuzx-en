...
(
	...
	'magic_present_note'	=> 'มอบไอเทม <a href="{url}" target="_blank">{name}</a> ให้กับคุณ',
	'friend_add'	=> '{actor} และคุณเป็นเพื่อนกันแล้ว',
	'friend_request'	=> '{actor} ร้องขอเพื่อเพิ่มคุณเป็นเพื่อน{note}&nbsp;&nbsp;<a onclick="showWindow(this.id, this.href, \'get\', 0);" class="xw1" id="afr_{uid}" href="{url}">รับคำขอ</a>',
	...
	'reason_warn_post'	=> '{actor} {modaction} กระทู้ <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> ของคุณ <br />
...
<p class="summary">หมายเลข: <span>{orderid}</span></p><p class="summary">ค่าใช้จ่าย: <span>฿ {price}  บาท</span></p><p class="summary">รายได้: <span>{value}</span></p>',
	...
	'reppost_noticeauthor'	=> '{actor} ตอบกระทู้ <a href="forum.php?mod=redirect&goto=findpost&ptid={tid}&pid={pid}" target="_blank">{subject}</a> ของคุณ&nbsp; <a class="lit" href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank">ดูรายละเอียด</a>',
	...
	'member_ban_speak'	=> '{user} คุณถูกแบนห้ามโพสต์ เป็นเวลา: {day} วัน (ถ้าเป็น 0 คือถูกแบนถาวร) เหตุผล: {reason}',

	'member_moderate_invalidate'	=> 'การตรวจสอบข้อมูลของคุณล้มเหลว กรุณา<a href="home.php?mod=spacecp&ac=profile">ส่งข้อมูลการสมัครสมาชิกเพื่อตรวจสอบอีกครั้ง</a><br />ข้อความของผู้ดูแล: <b>{remark}</b>',
	'member_moderate_validate'	=> 'แอคเคานต์สมาชิกของคุณผ่านการตรวจสอบได้รับการอนุมัติแล้ว<br />ข้อความของผู้ดูแล: <b>{remark}</b>',
	'member_moderate_invalidate_no_remark'	=> 'การตรวจสอบข้อมูลของคุณล้มเหลว กรุณา<a href="home.php?mod=spacecp&ac=profile">ส่งข้อมูลการสมัครสมาชิกเพื่อตรวจสอบอีกครั้ง</a>',
	'member_moderate_validate_no_remark'	=> 'แอคเคานต์สมาชิกของคุณผ่านการตรวจสอบได้รับการอนุมัติแล้ว',
	'manage_verifythread'	=> 'มีกระทู้ที่รอการตรวจสอบใหม่<a href="admin.php?action=moderate&operation=threads&dateline=all">ตรวจสอบตอนนี้</a>',
	'manage_verifypost'	=> 'มีโพสต์ที่รอการตรวจสอบใหม่<a href="admin.php?action=moderate&operation=replies&dateline=all">ตรวจสอบตอนนี้</a>',
	'manage_verifyuser'	=> 'มีสมาชิกที่รอการตรวจสอบใหม่<a href="admin.php?action=moderate&operation=members">ตรวจสอบตอนนี้</a>',
	'manage_verifyblog'	=> 'มีบล็อคที่รอการตรวจสอบใหม่<a href="admin.php?action=moderate&operation=blogs">ตรวจสอบตอนนี้</a>',
	'manage_verifydoing'	=> 'มีสถานะที่รอการตรวจสอบใหม่<a href="admin.php?action=moderate&operation=doings">ตรวจสอบตอนนี้</a>',
	'manage_verifypic'	=> 'มีรูปภาพที่รอการตรวจสอบใหม่<a href="admin.php?action=moderate&operation=pictures">ตรวจสอบตอนนี้</a>',
	'manage_verifyshare'	=> 'มีการแบ่งปันที่รอการตรวจสอบใหม่<a href="admin.php?action=moderate&operation=shares">ตรวจสอบตอนนี้</a>',
	'manage_verifycommontes'	=> 'มีข้อความ/ความเห็นที่รอการตรวจสอบใหม่<a href="admin.php?action=moderate&operation=comments">ตรวจสอบตอนนี้</a>',
	'manage_verifyrecycle'	=> 'ถังรีไซเคิลมีกระทู้ที่รอการตรวจสอบใหม่<a href="admin.php?action=recyclebin">จัดการตอนนี้</a>',
	'manage_verifyrecyclepost'	=> 'ถังรีไซเคิลมีโพสต์ที่รอการตรวจสอบใหม่<a href="admin.php?action=recyclebinpost">จัดการตอนนี้</a>',
	'manage_verifyarticle'	=> 'มีบทความที่รอการตรวจสอบใหม่<a href="admin.php?action=moderate&operation=articles">ตรวจสอบตอนนี้</a>',
	'manage_verifymedal'	=> 'มีเหรียญรางวัลที่รอการตรวจสอบใหม่<a href="admin.php?action=medals&operation=mod">ตรวจสอบตอนนี้</a>',
	'manage_verifyacommont'	=> 'มีบทความที่รอการตรวจสอบใหม่<a href="admin.php?action=moderate&operation=articlecomments">ตรวจสอบตอนนี้</a>',
	'manage_verifytopiccommont'	=> 'มีหัวข้อที่รอการตรวจสอบใหม่<a href="admin.php?action=moderate&operation=topiccomments">ตรวจสอบตอนนี้</a>',
	'manage_verify_field'	=> 'มีการกรอก{verifyname}และรอการตรวจสอบใหม่<a href="admin.php?action=verify&operation=verify&do={doid}">จัดการตอนนี้</a>',
	'system_notice'	=> '{subject}<p class="summary">{message}</p>',
	'system_adv_expiration'	=> 'โฆษณาในไซต์ต่อไปนี้จะสิ้นสุดใน {day} วัน, กรุณาจัดการ:<br />{advs}',
	'report_change_credits'	=> '{actor} จัดการกับรายงานของคุณ {creditchange}',
	'new_report'		=> 'ประมวลผลรายงานใหม่ <a href="admin.php?action=report" target="_blank">คลิกที่นี่เพื่อเข้าสู่การประมวลผล</a>',
	'new_post_report'	=> 'มีการรายงานที่รอการตรวจสอบใหม่, <a href="forum.php?mod=modcp&action=report&fid={fid}" target="_blank">คลิกที่นี่เพื่อเข้าสู่ศูนย์จัดการระบบ</a>',
	'magics_receive'	=> '{actor} มอบไอเทม {magicname} ให้กับคุณ
				<p class="summary">{actor} พูดว่า: <span>{msg}</span></p>
				<p class="mbn"><a href="home.php?mod=magic" target="_blank">รับไอเทม</a>
				<span class="pipe">|</span><a href="home.php?mod=magic&action=mybox" target="_blank">ดูกล่องไอเทมของฉัน</a></p>',
