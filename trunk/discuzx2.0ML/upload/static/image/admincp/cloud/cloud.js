...
/*vot*/			apiTdFirst.innerHTML = '<strong>'+lng['int_cloud_test']+'</strong>';
		} else if (apiType == 2) {
/*vot*/			apiTdFirst.innerHTML = '<strong>'+lng['int_roaming_test']+'</strong>';
		} else if (apiType == 3) {
/*vot*/			apiTdFirst.innerHTML = '<strong>'+lng['int_qq_test']+'</strong>';
		}
