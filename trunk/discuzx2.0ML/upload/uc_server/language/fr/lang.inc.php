...
$lang = array(
	...
	'VI_UTF8'	=> 'Tiếng Việt UTF8',
	'SC_GBK'	=> '简体中文版',
	'TC_BIG5'	=> '繁体中文版',
	'SC_UTF8'	=> 'Tiếng Trung SC UTF8',
	'TC_UTF8'	=> '繁体中文 UTF8 版',
	...
	'redirect'	=> 'Trình duyệt đang chuyển trang, vui lòng chờ.<br>除非当您的浏览器没有自动跳转时, 请点击这里',
...
define('UC_VERNAME', 'Vietnamienne'); // define('UC_VERNAME', 'Tiếng Việt');

$lang = array(

	'VI_UTF8'	=> 'Vietnamienne UTF8', // 'Tiếng Việt UTF8'
...
// ligne 379 jusqu a 419 ci dessus retrouver ci dessous l original
/*
	'install_succeed'	=> '安装用户中心成功, 点击进入下一步',
	'license'	=> '<div class="license"><h1>中文版授权协议 适用于中文用户</h1>
