...
$nextpstep = $pstep + 1;
if($continue) {
	showmessage(lang('update','continue_convert_table').$table_source.lang('update','was_converted').$total.lang('update','records'), "index.php?a=$action&source=$source&prg=$curprg&pstep=$nextpstep&total=$total");
}
?>