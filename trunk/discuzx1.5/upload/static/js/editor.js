...
/*vot*/	$(editorid + '_fullswitcher').title = lng['bad_browser'];
	}
...
/*vot*/	$(editorid + '_fullswitcher').innerHTML = editorisfull ? lng['restore_size'] : lng['full_screen'];
}
...
/*vot*/			str += '<div id="tbltips_msg" style="display: none">'+lng['table_intro1']+'<div class=\'xs0\' style=\'margin:0 5px\'>'+lng['table_intro2']+'</div>'+lng['table_intro3']+'</div>';
				break;
			case 'aud':
/*vot*/			str = '<p class="pbn">'+lng['audio_url']+':</p><p class="pbn"><input type="text" id="' + ctrlid + '_param_1" class="px" value="" style="width: 220px;" /></p><p class="pbn"><label for="' + ctrlid + '_param_2"><input type="checkbox" id="' + ctrlid + '_param_2" class="pc" value="1"/> '+lng['auto_play']+'</label><br /></p><p class="xg2 pbn">'+lng['audio_support']+'</p>';
				break;
			case 'vid':
/*vot*/			str = '<p class="pbn">'+lng['video_url']+':</p><p class="pbn"><input type="text" value="" id="' + ctrlid + '_param_1" style="width: 220px;" class="px" /></p><p class="pbn">'+lng['width']+': <input id="' + ctrlid + '_param_2" size="5" value="500" class="px" /> &nbsp; '+lng['height']+': <input id="' + ctrlid + '_param_3" size="5" value="375" class="px" /></p><p class="pbn"><label for="' + ctrlid + '_param_4"><input type="checkbox" id="' + ctrlid + '_param_4" class="pc" value="1"/> '+lng['auto_play']+'</label><br /></p><p class="xg2 pbn">'+lng['video_support']+'</p>';
				break;
			case 'fls':
...
/*vot*/	menu.innerHTML = '<div class="p_opt cl"><span class="y" style="margin:-10px -10px 0 0"><a onclick="hideMenu()" class="flbc" href="javascript:;">'+lng['close']+'</a></span><div>' + str + '</div><div class="pns mtn"><button type="submit" id="' + ctrlid + '_submit" class="pn pnc"><strong>'+lng['submit']+'</strong></button><button type="submit" onClick="hideMenu()" class="pn"><em>'+lng['cancel']+'</em></button></div></div>';
