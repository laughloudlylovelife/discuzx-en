...
drag.extend({
	'getBlocksTimer' : '',
	'blocks' : [],
/*vot*/	'blockDefaultClass' : [{'key':lng['choose_style'],'value':''},{'key':lng['style1'],'value':'xbs_1'},{'key':lng['style2'],'value':'xbs xbs_2'},{'key':lng['style3'],'value':'xbs xbs_3'},{'key':lng['style4'],'value':'xbs xbs_4'},{'key':lng['style5'],'value':'xbs xbs_5'},{'key':lng['style6'],'value':'xbs xbs_6'},{'key':lng['style7'],'value':'xbs xbs_7'}],
/*vot*/	'frameDefaultClass' : [{'key':lng['choose_style'],'value':''},{'key':lng['no_border'],'value':'xfs xfs_nbd'},{'key':lng['style1'],'value':'xfs xfs_1'},{'key':lng['style2'],'value':'xfs xfs_2'},{'key':lng['style3'],'value':'xfs xfs_3'},{'key':lng['style4'],'value':'xfs xfs_4'},{'key':lng['style5'],'value':'xfs xfs_5'}],
...
/*vot*/	table += '<tr><th>'+lng['font']+'</th><td><input type="text" id="fontsize" class="px p_fre" value="'+fontsize+'" size="2" /> px <input type="text" id="fontcolor" class="px p_fre" value="'+fontcolor+'" size="2" />';
		table += getColorPalette(id+'_fontPalette', 'fontcolor' ,fontcolor)+'</td></tr>';
/*vot*/	table += '<tr><th>'+lng['link']+'</th><td><input type="text" id="linkfontsize" class="px p_fre" value="'+linkfontsize+'" size="2" /> px <input type="text" id="linkcolor" class="px p_fre" value="'+linkcolor+'" size="2" />';
...
/*vot*/	table += '<li><label>'+lng['top']+'</label><select class="ps" id="bdtwidth" ><option value="">'+lng['size']+'</option>'+this.getOption(widtharr,bdtwidth)+'</select>';
/*vot*/	table += ' <select class="ps" id="bdtstyle" ><option value="">'+lng['style']+'</option>'+this.getOption(stylearr,bdtstyle)+'</select>';
/*vot*/	table += ' '+lng['color']+' <input type="text" id="bdtcolor" class="px p_fre" value="'+bdtcolor+'" size="7" />';
		table += getColorPalette(id+'_bdtPalette', 'bdtcolor' ,bdtcolor)+'</li>';

/*vot*/	table += '<li class="bordera mtn"><label>'+lng['right']+'</label><select class="ps" id="bdrwidth" ><option value="">'+lng['size']+'</option>'+this.getOption(widtharr,bdrwidth)+'</select>';
/*vot*/	table += ' <select class="ps" id="bdrstyle" ><option value="">'+lng['style']+'</option>'+this.getOption(stylearr,bdrstyle)+'</select>';
/*vot*/	table += ' '+lng['color']+' <input type="text" id="bdrcolor" class="px p_fre" value="'+bdrcolor+'" size="7" />';
		table += getColorPalette(id+'_bdrPalette', 'bdrcolor' ,bdrcolor)+'</li>';

/*vot*/	table += '<li class="bordera mtn"><label>'+lng['bottom']+'</label><select class="ps" id="bdbwidth" ><option value="">'+lng['size']+'</option>'+this.getOption(widtharr,bdbwidth)+'</select>';
/*vot*/	table += ' <select class="ps" id="bdbstyle" ><option value="">'+lng['style']+'</option>'+this.getOption(stylearr,bdbstyle)+'</select>';
/*vot*/	table += ' '+lng['color']+' <input type="text" id="bdbcolor" class="px p_fre" value="'+bdbcolor+'" size="7" />';
/*vot*/	table += getColorPalette(id+'_bdbPalette', 'bdbcolor' ,bdbcolor)+'</li>';
...
/*vot*/	table += ' <select class="ps" id="bdlstyle" ><option value="">'+lng['style']+'</option>'+this.getOption(stylearr,bdlstyle)+'</select>';
/*vot*/	table += ' '+lng['color']+' <input type="text" id="bdlcolor" class="px p_fre" value="'+bdlcolor+'" size="7" />';
...
/*vot*/	table += '<tr><th>'+lng['margin']+'</th><td><div id="margindiv" class="'+ulclass+'"><span><label>'+lng['top']+'</label><input type="text" id="margint" class="px p_fre" value="'+margint+'" size="1"/>px </span>';
/*vot*/	table += '<span class="bordera"><label>'+lng['right']+'</label><input type="text" id="marginr" class="px p_fre" value="'+marginr+'" size="1" />px </span>';
/*vot*/	table += '<span class="bordera"><label>'+lng['bottom']+'</label><input type="text" id="marginb" class="px p_fre" value="'+marginb+'" size="1" />px </span>';
/*vot*/	table += '<span class="bordera"><label>'+lng['left']+'</label><input type="text" id="marginl" class="px p_fre" value="'+marginl+'" size="1" />px </span>';
...
/*vot*/		table += '<tr><th>'+lng['padding']+'</th><td><div id="cmargindiv" class="'+ulclass+'">';
...
/*vot*/	table += '<tr><th>'+lng['bg_color']+'</th><td><input type="text" id="bgcolor" class="px p_fre" value="'+bgcolor+'" size="4" />';
		table += getColorPalette(id+'_bgcPalette', 'bgcolor' ,bgcolor)+'</td></tr>';
/*vot*/	table += '<tr><th>'+lng['bg_image']+'</th><td><input type="text" id="bgimage" class="px p_fre" value="'+bgimage+'" size="25" /> <select class="ps" id="bgrepeat" >'+this.getOption(repeatarr,bgrepeat)+'</select></td></tr>';
		var classarr = objType == 1 ? this.blockDefaultClass : this.frameDefaultClass;
/*vot*/	table += '<tr><th>'+lng['class']+'</th><td><input type="text" id="diyClassName" class="px p_fre" value="'+diyClassName+'" size="8" /> <select class="ps" id="bgrepeat" onchange="$(\'diyClassName\').value=this.value;" >'+this.getOption(classarr, diyClassName)+'</select></td></tr>';
		table += '</table>';
...
/*vot*/	common += '<tr><th>'+lng['bg_image']+':</th><td><input type="text" id="titleBgImage" class="px p_fre" value="'+bgimage+'" /> <select class="ps" id="titleBgRepeat" >'+this.getOption(repeatarr,bgrepeat)+'</select></td></tr>';
...
/*vot*/	li += '<tr><th>'+lng['position']+':</th><td><select id="titleFloat_0" ><option value="" `left`>'+lng['align_left']+'</option><option value="right" `right`>'+lng['align_right']+'</option></select>';
/*vot*/	li += '&nbsp;&nbsp;'+lng['offset']+':<input type="text" id="titleMargin_0" class="px p_fre" value="`margin`" size="2" />px</td></tr>';
/*vot*/	li += '<tr><th>'+lng['font']+':</th><td><select class="ps" id="titleSize_0" ><option value="">'+lng['size']+'</option>`size`</select>';
/*vot*/	li += '&nbsp;&nbsp;'+lng['color']+': <input type="text" id="titleColor_0" class="px p_fre" value="`color`" size="4" />';
...
/*vot*/		f += '<strong>'+lng['submit']+'</strong></button><button onclick="drag.closeTitleEdit(\''+fid+'\')" class="pn" value="true"><strong>'+lng['cancel']+'</strong></button></p>';
		this.removeMenu(e);
...
/*vot*/		$('allupdate').innerHTML = lng['update_completed'];
	...
	getBlocks : function () {
		...
		if (this.blocks.length > 0) {
			...
			if($('allupdate')) {
/*vot*/			$('allupdate').innerHTML = lng['total']+' <span style="color:blue">'+this.blocksLen+'</span>'+lng['blocks']+', '+lng['updating_the']+' <span style="color:red">'+cur+'</span> '+lng['ones']+', '+lng['done']+' <span style="color:red">'+(parseInt(cur / this.blocksLen * 100)) + '%</span>';
...
/*vot*/							'<label><input type="radio" value="1" name="savemod"'+dchecked+' />'+lng['apply_current_page']+'</label></form>','notice', '', spaceDiy.save);
					return false;
				}
