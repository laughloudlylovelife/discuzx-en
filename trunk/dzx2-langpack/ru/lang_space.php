...
$lang = array(
	...
	'wall_form'		=> '<div class="space_wall_post">
					...
					'<div class="pt hm">Вы должны авторизироваться для продолжения. <a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href)" class="xi2">Вход</a> | <a href="member.php?mod='.$_G['setting']['regname'].'" class="xi2">'.$_G['setting']['reglinkname'].'</a></div>').'
	...
	'block_profile_friend_add'	=> 'Друг++',
	'block_profile_friend_ignore'	=> 'Друг--',
	...
	'sb_thread'		=> 'Темы {who}',
	'doing_you_can'		=> 'Опишите своё настроение или что Вы сейчас делаете ...',
