...
$lang = array(
	...
	'mail_my'		=> 'แจ้งเตือนการกระทำเพื่อนของฉัน',
	'mail_system'		=> 'แจ้งเตือนระบบ',
	...
	'invite_massage'	=> '<table border="0">
				...
				<br>
				หากคุณยินดียอมรับคำเชิญชวน：<br>{saymsg}
				<br><br>
				<strong>กรุณาคลิกที่ลิงค์ด้านล่าง เพื่อยอมรับคำเชิญชวน：</strong><br>
				<a href="{inviteurl}">{inviteurl}</a><br>
				<br>
				<strong>ถ้าคุณเป็นสมาชิกของ{sitename}อยู่แล้ว โปรดคลิกที่ลิงค์ด้านล่างเพื่อเข้าเยี่ยมชมโปรไฟล์ของฉัน：</strong><br>
	...
	'app_invite_massage'	=> '<table border="0">
				...
				<br>
				หากคุณยินดียอมรับคำเชิญชวน：<br>
				{saymsg}
				<br><br>
				<strong>โปรดคลิกที่ลิงค์ด้านล่าง เพื่อยอมรับคำเชิญชวนและร่วมสนุกกับ {appname} ด้วยกัน：</strong><br>
				<a href="{inviteurl}">{inviteurl}</a><br>
				<br>
				<strong>ถ้าคุณเป็นสมาชิกของ{sitename}อยู่แล้ว โปรดคลิกที่ลิงค์ด้านล่างเพื่อเข้าเยี่ยมชมโปรไฟล์ของฉัน：</strong><br>
				<a href="{siteurl}home.php?mod=space&uid={uid}">{siteurl}home.php?mod=space&uid={uid}</a><br>
	...
	'active_email_msg'	=> 'กรุณาคัดลอกลิงก์เปิดใช้งานต่อไปนี้ลงในเบราว์เซอร์ เพื่อเปิดการใช้งานอีเมลของคุณ<br>ลิงค์สำหรับเปิดใช้งานอีเมล:<br><a href="{url}" target="_blank">{url}</a>',
	...
	'not_allow_upload_extend'	=> 'ประเภทไฟล์ {extend} ไม่อนุญาตในการอัพโหลดรูปภาพ',
	'files_can_not_exceed_size'	=> 'ประเภทไฟล์ {extend} ไม่สามารถมีขนาดเกิน {size} ได้',
	'get_passwd_subject'	=> 'คำขอเปลี่ยนรหัสผ่านใหม่',
	'get_passwd_message'	=> 'คลิกลิงค์ด้านล่างนี้เพื่อตั้งค่ารหัสผ่านของคุณ ลิ้งค์นี้จะมีอายุเพียง 3 วันเท่านั้น：<br />\\1<br />(ให้ทำการคัดลอกลิ้งแล้ววางที่บราวเศอร์หากลิ้งค์ไม่สามารถคลิกได้)<br />เมื่อไปยังลิ้งค์ที่ส่งมาแล้ว ป้อนรหัสผ่านใหม่ หลังจากนั้นคุณสามารถใช้รหัสผ่านใหม่เพื่อเข้าสู่ระบบ',
	'file_is_too_big'	=> 'ไฟล์ขนาดใหญ่เกินไป',

	'take_part_in_the_voting'		=> '{actor} โหวตโพล์ <a href="{url}" target="_blank">{subject}</a> ของ {touser} ได้รับ {reward} ',
	...
	'unable_to_create_upload_directory_server'	=> 'ไม่สามารถสร้างไดเรกทอรีสำหรับเก็บไฟล์ที่อัพโหลดบนเซิร์ฟเวอร์ได้',
	'inadequate_capacity_space'		=> 'ความจุของพื้นที่ไม่เพียงพอ ไม่สามารถอัปโหลดไฟล์ใหม่',
	'mobile_picture_temporary_failure'	=> 'ไม่สามารถย้ายไฟล์ที่ระบุไปยังไปยังไดเรกทอรีชั่วคราวบนเซิร์ฟเวอร์ได้',
	...
	'space_open_subject'	=> 'แจ้งเตื่อน ให้ดูแลและอัพเดตโปรไฟล์ส่วนตัวของคุณ',
	...
	'present_user_magics'	=> 'คุณได้รับไอเทม \\1 เป็นของขวัญจากผู้ดูแลระบบ',
	'has_not_more_doodle'	=> 'คุณไม่ได้วาดภาพ',

	'do_stat_login'		=> 'เข้าสู่ระบบ',
	'do_stat_mobilelogin'	=> 'การเข้าชมอุปกรณ์โทรศัพท์',
	'do_stat_connectlogin'	=> 'เปิดใช้ QQ Login',
	'do_stat_register'	=> 'สมัครสมาชิกใหม่',
	...
	'do_stat_group'		=> 'สร้างกลุ่ม',
	'do_stat_tgroup'	=> 'กลุ่ม',
	'do_stat_home'		=> 'พื้นที่',
	'do_stat_forum'		=> 'ฟอรั่ม',
...
//	'do_stat_post'		=> 'ตอบกลับกระทู้',
	'do_stat_click'		=> 'แสดงความรู้สึก',
	'do_stat_wall'		=> 'ฝากข้อความ',
	'do_stat_poke'		=> 'ทักทาย',
	'do_stat_sendpm'	=> 'ส่งข้อความ',
	'do_stat_addfriend'	=> 'เพิ่มเพื่อน',
	'do_stat_friend'	=> 'เป็นเพื่อนกัน',
	'do_stat_post_number'	=> 'จำนวนโพสต์',
	'do_stat_statistic'	=> 'สถิติโดยรวม',
	'logs_credit_update_TRC'	=> 'รางวัลภารกิจ',
	'logs_credit_update_RTC'	=> 'รางวัลกระทู้',
	'logs_credit_update_RAC'	=> 'คำตอบที่ดีที่สุด',
	'logs_credit_update_MRC'	=> 'ได้จากไอเทมสุ่ม',
	'logs_credit_update_BMC'	=> 'ซื้อไอเทม',
	'logs_credit_update_TFR'	=> 'โอนออก',
	'logs_credit_update_RCV'	=> 'โอนเข้า',
	...
	'logs_credit_update_RPC'	=> 'ได้รางวัลรายงาน',
	'logs_credit_update_ACC'	=> 'เข้าร่วมในกิจกรรม',
	'logs_credit_update_RCT'	=> 'ให้รางวัลตอบกระทู้',
	'logs_credit_update_RCA'	=> 'ได้รับรางวัลตอบกระทู้',
	'logs_credit_update_RCB'	=> 'ได้รับโบนัสเครดิตตอบกลับ',
	'logs_credit_update_CDC'	=> 'รหัสบัตรเงินสด',

	'logs_credit_update_RGC'	=> 'Remove Gift',//'回收红包',
	'logs_credit_update_BGC'	=> 'Return Gift',//'埋下红包',
	'logs_credit_update_AGC'	=> 'ได้รับอังเปา',
	'logs_credit_update_RKC'	=> 'ประมูลอันดับ',
	'logs_select_operation'		=> 'กรุณาเลือกประเภทการดำเนินการ',
	...
	'magic_credit'			=> 'สุ่มไอเทมเพื่อรับเครดิต',
	...
	'profile_verify_modify_error'	=> '{verify}ได้รับการรับรองไม่อนุญาตให้แก้ไข',
...
//'district_level_0'		=> '- Country -',//'-国家-',
	...
	'email_acitve_message'		=> '<img src="{imgdir}/mail_inactive.png" alt="ยังไม่ได้ตรวจสอบ" class="vm" />
						<span class="xi1">อีเมล์ใหม่({newemail})กำลังรอการตรวจสอบ...</span><br />
						ระบบได้ส่งอีเมล์การตรวจสอบไปยังอีเมล์ที่ต้องยืนยันแล้ว, กรุณาเช็คอีเมล์ของคุณเพื่อตรวจสอบการยืนยันครั้งนี้<br>
						หากคุณไม่ได้รับอีเมล์การตรวจสอบนี้, คุณสามารถเปลี่ยนอีเมล์, หรือ<a href="home.php?mod=spacecp&ac=profile&op=password&resend=1" class="xi2">รับอีเมล์การยืนยันอีกครั้ง</a>',
