...
//static/js/editor_base.js
	...
	'plain_text_warn'	: 'ربما خلال التحويل الى الوضع النصي يتم فقدان بعض التنسيق!\n هل أنت متأكد من المواصلة?',//'转换为纯文本时将会遗失某些格式。\n您确定要继续吗？',
...
//static/js/common.js
	...
	'close'			: 'إغلاق',//'关闭',
	'wheel_zoom'		: 'استخدم عجلة الفأرة للتقريب او التبعيد',//'鼠标滚轮缩放图片',
	'reminder'		: 'تذكير',//'提示信息',
	'submit'		: 'موافق',//'确定',
//	'submit'		: 'موافق',//'提交',
	'cancel'		: 'الغاء',//'取消',
//	'cancel'		: 'الغاء',//'取消',
	...
	'flash_required'	: 'هذا المحتوى يطلب  Adobe Flash Player 9.0.124 او أحدث',//'此内容需要 Adobe Flash Player 9.0.124 或更高版本',
	...
	'custom'		: 'مخصص',//'自定义',
	'permanent'		: 'دائم',//'永久',
	'show_all_expr'		: 'اظهار كافة الابتسامات',//'显示所有表情',
	...
	'code_invalid'		: 'خطأ في رمز الامان, حاول مرة اخرى',//'验证码错误，请重新填写',
	'q&a_invalid'		: 'اجابة السؤال خاطئة , حاول مرة اخرى',//'验证问答错误，请重新填写',
	...
	'logging_wait'		: 'تسجيل الدخول, الرجاء الانتظار...',//'登录中，请稍后...',
	'notices_no'		: '[   ]',//'【　　　】',
	...
	'jump_now'		: 'الانتقال فوراً',//'立即跳转',
	'error_message'		: 'رسالة خطأ',//'错误信息',
	'ctrl_d_favorites'	: 'اضغط على زري  Ctrl + D للوضع بالمفضلة',//'请按 Ctrl+D 键添加到收藏夹',
...
//static/js/seditor.js
	...
	'when_thread_replied'	: 'اظهار عندما يرد العضو على هذا الموضوع ',//'只有当浏览者回复本帖时才显示',
	'when_points_more'	: 'اظهار عندما تكون نقاط العضو اكثر من  ',//'只有当浏览者积分高于',
	...
	'table_intro2'		: '[table]<br />الاسم:|Discuz!<br />الاصدار:|X1.5<br />[/table]',//'[table]<br />Name:|Discuz!<br />Version:|X1<br />[/table]',
	...
	'click_autosave_enable'	: 'اضغط هنا لتفعيل الحفظ التلقائي',//'点击开启自动保存',
...
//	'height_optional'	: 'Height (optional)',//'高(可选)',
	'enter_item_list'	: 'ادخل قائمة العناصر.\r\nاتركها فارغة, او اضغط زر الغاء.',//'输入一个列表项目.\r\n留空或者点击取消完成此列表.',
...
//	'insert_quote'		: 'Insert the Quote',//'请输入要插入的引用',
	'width'			: 'العرض',//'宽',
	'height'		: 'الطول',//'高',
	'audio_support'		: 'يدعم wma, mp3, ra, rm, وصيغ اخرى<br />مثل: http://server/audio.wma',//'支持 wma mp3 ra rm 等音乐格式<br />示例: http://server/audio.wma',
	'video_support'		: 'يدعم Youku, potatoes, 56, 6, cool video مواقع اخرى و <br /> يدعم الصيغ wmv avi rmvb mov swf flv  <br /> مثال: http://server/movie.wmv',//'支持优酷、土豆、56、酷6等视频站的视频网址<br />支持 wmv avi rmvb mov swf flv 等视频格式<br />示例: http://server/movie.wmv',
...
//	'new_reply_exists'	: ' new replies in the thread, click to view',//'条存在新回复的主题，点击查看',
	'new_reply_exists'	: 'الموضوع يحتوي على ردود جديدة, اضغط للعرض',//'有新回复的主题，点击查看',
//--------------------------------
...
//	'check_length'		: 'تعداد الكلمات',//'字数检查',
	'enter_content'		: 'ادخل المحتوى او العنوان',//'请完成标题或内容栏',
...
//	'system_limit'		: 'System limit',//'系统限制',
//	'up_to'			: 'to',//'到',
	'ignore_pending_attach'	: 'هناك مرفقات قيد الانتظار, هل تريد تجاهلهم?',//'您有等待上传的附件，确认不上传这些附件吗？',
	'still_uploading'	: 'هناك بعض المرفقات قيد الرفع, الرجاء الانتظار. سيتم نشر الموضوع تلقائي بعد انتهاء الرفع...',//'您有正在上传的附件，请稍候，上传完成后帖子将会自动发表...',
...
//	'code_invalid'			: 'Wrong security code, please try again',//'验证码错误，请重新填写',
	...
	'upload_finished'	: 'تم الانتهاء من الرفع!',//'附件上传完成！',
	'successfull'		: 'نجح:',//'成功',
	'failed'		: 'فشل:',//'失败',
	'ones'			: 'وحدة',//'个',
...
//	'cancel'		: 'Cancel',//'取消',
	...
	'attach_daily_big'	: 'لقد تجاوز عدد المرفقات يومياً الحد الاقصى',//'本日已无法上传更多的附件',
	'validating_q&a'	: 'التحقق من  س & ج, الرجاء الانتظار',//'验证问答校验中，请稍后',
	'validating_code'	: 'التأكد من الرمز, يرجى الانتظار',//'验证码校验中，请稍后',
...
//	'system_limit'		: 'System limit',//'系统限制',
//	'up_to'			: 'الى',//'到',
	'premoderated'		: 'الردود لهذا القسم يجب ان يتم التحقق منها. لن يتم اظهار مشاركتك الا بعد مراجعتها',//'本版回帖需要审核，您的帖子将在通过审核后显示',
//	'credit_confirm1'	: 'This costs ',//'下载积分将',
	...
	'notify_on_reply_cancel'	: 'الغاء استقبال التنبيه',//'取消回复通知',
	'share_connection_failed'	: 'فشل الاتصال للمشاركة, حاول مرة اخرى لاحقاً',//'分享服务连接失败，请稍后再试',
...
//static/js/home.js
	'day'			: 'يوم',//'日',
	'category_empty'	: 'اسم القسم لا يمكن تركه فارغاً!',//'分类名不能为空！',
...
//static/js/home_blog.js
	...
	'title_length_invalid'	: 'طول العنوان (يجب ان يكون من   1~80 حرف) ليس كالمطلوب',//'标题长度(1~80字符)不符合要求',

//--------------------------------
//static/js/home_common.js

	'show_orig_image'	: 'اظهار الصورة الاصلية في نافذة جديدة',//'点击图片，在新窗口显示原始尺寸',
	'continue_sure'		: 'هل أنت متأكد من المضي قدما?',//'您确定要执行本操作吗？',
	'select_item'		: 'الرجاء اختيار عنصر لإجراء العملية',//'请选择要操作的对象',
...
//static/js/home_friendselector.js
	...
	'select_max'		: 'يمكنك تحديد الى ما يصل ',//'最多只允许选择',
	'users'			: 'اعضاء',//'个用户',
	'allready_exists'	: 'موجود مسبقاً',//'已经存在',

//--------------------------------
//static/js/home_manage.js

	'you_friends_now'	: 'انتما اصدقاء الان, تستطيع  ',//'你们现在是好友了，接下来，您还可以：',
...
//	'collapse'			: 'Collapse',//'收起',
	...
	'more_feeds'		: 'المزيد من الاخبار',//'更多动态',
//	'day'			: 'Day',//'日',
...
//static/js/home_uploadpic.js
	...
	'insert_to_content'	: 'اضغط هنا للإدارة مكان مؤشر الفأرة',//'点击这里插入内容中当前光标的位置',
	'insert'		: 'ادراج',//'插入',
//	'delete'		: 'حذف',//'删除',
	'image_description'	: 'وصف الصورة',//'图片描述',
//	'upload_ok'		: 'نجح الرفع',//'上传成功',
//	'upload_failed'		: 'فشل الرفع',//'上传失败',
	'uploading_wait'	: 'جاري الرفع, الرجاء الانتظار',//'上传中，请等待',
	'retry'			: 'اعادة المحاولة',//'重试',
...
//static/js/portal.js
	...
	'choose_block'		: 'اختيار كتلة',//'选择模块',
	'blocks_found1'		: 'وجد',//'找到',
	'blocks_found2'		: ' كتل مطابقة ',//'个相应的模块',
	'blocks_not_found'	: 'لا يوجد',//'没有相应的模块',
	'select_block'		: 'قم بتحديد الكتلة!',//'请选择一个模块！',
	'show_settings'		: 'اظهار الاعدادات',//'展开设置项',
	'hide_settings'		: 'اخفاء الاعدادات',//'收起设置项',
	'block_name_empty'	: 'لا يمكن ترك اسم الكتلة فارغ',//'模块标识不能为空',
	'block_convert_sure'	: 'هل أنت متأكد من ذلك',//'你确定要转换模块的类型从',
	'back'			: 'رجوع',//'返回',
	'settings_expand'	: 'توسيع الاعدادات',//'展开设置项',
	'settings_hide'		: 'اخفاء الاعدادات',//'收起设置项',
...
//	'link'			: 'وصلة',//'链接',
	'image'			: 'صورة',//'图片',
	'position'		: 'الموقع',//'位置',
	'align_left'		: 'الى اليمين',//'居左',
	'align_right'		: 'الى اليسار',//'居右',
	'offset'		: 'الازاحة',//'偏移量',
//	'font'			: 'الخط',//'字体',
//	'size'			: 'الحجم',//'大小',
//!!! mainly the same as 'color' !!!!!!
//	'colour'		: 'اللون',//'色',
	'add_new_title'		: 'اضافة عنوان جديد',//'添加新标题',
//	'edit'			: 'Edit',//'编辑',
//	'title'			: 'Title',//'标题',
//	'close'			: 'Close',//'关闭',
//	'submit'		: 'Submit',//'确定',
...
//	'warn_not_saved'	: 'You have modified the data. If you exit, all the changes will be lost.',//'您的数据已经修改,退出将无法保存您的修改。',
	...
	'save_temp_sure'	: 'حفظ البيانات المؤقتة?<br /> اضغط موافق للحفظ, اضغط على الغاء لحذف البيانات المؤقتة ',//'是否保留暂存数据？<br />按确定按钮将保留暂存数据，按取消按钮将删除暂存数据。',
	...
	'continue_temp_sure'	: 'مواصلة الى  DIY مع البيانات المؤقتة?',//'是否继续暂存数据的DIY？',
//	'warn_not_saved'	: 'You have modified the data. If you exit, all the changes will be lost.',//'您的数据已经修改,退出将无法保存您的修改。',
	'update_completed'	: 'تم التحديث البيانات بنجاح.',//'已更新完成。',
	'tab_label'		: 'علامة التبويب',//'tab标签',
	'temp_action'		: 'اضغط على "استمرار" لجلب المعلومات الحالية للاستايل الحالي,<br />اضغط على زر  "حذف" لحذف البيانات المؤقتة.',//'按继续按钮将打开暂存数据并DIY，<br />按删除按钮将删除暂存数据。',
	'continue'		: 'مواصلة',//'继续',
...
//static/js/register.js
	...
	'username_invalid'	: 'اسم المستخدم يحتوي على حروف ممنوعة',//'用户名包含敏感字符',
	'username_short'	: 'اسم المستخدم اقل من 3 حروف',//'用户名小于 3 个字符',
	'username_long'		: 'اسم المستخدم اكبر من 15 حرف',//'用户名超过 15 个字符',
...
//static/js/threadsort.js
	...
	'value_is_less'		: 'القيمة اقل من المطلوب',//'小于设置最小值',
//--------------------------------
...
//source/function/function_admincp.php
	'version_uptodate'	: 'انت تستعمل اعلى اصدارات ديسكاز حالياً. يرجى الرجوع إلى النصائح التالية لإجراء ترقيات في الوقت المناسب.',

//-------------------------------------
//api/manyou/cloud_iframe.js
	'add_operation'		: 'اضافة الى العمليات الشائعة',//'&#28155;&#21152;&#21040;&#24120;&#29992;&#25805;&#20316;',
