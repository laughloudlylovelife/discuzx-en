...
(
	...
	'server_busy'	=> 'عذراً, يوجد خلل في الاتصال, حاول مرة اخرى. شكراً لك.',//'抱歉，当前存在网络问题或服务器繁忙，请您稍候再试。谢谢。',
	...
	'qzone_shareto'	=> 'نشر الى ملف QQ',//'分享到QQ空间',
	'qzone_to_friend'	=> 'نشر للأصدقاء',//'分享给好友',
	'qzone_reason_default'	=> 'يمكنك ادخال تفاصيل النشر',//'可以在这里输入分享原因或详细内容',
	...
	'weibo_input'	=> 'يمكنك ادخال <strong id=checklen></strong> حرف',//'还能输入<strong id=checklen></strong>字',
	'weibo_select_picture'	=> 'الرجاء اختيار صورة للنشر',//'请选择分享图片',
	'weibo_share'	=> 'نشر',//'转播',
	'weibo_share_to'	=> 'نشر الى تدوينات Tencent',//'转播到腾讯微博',
	'weibo_reason_is_long'	=> 'محتوى التدوينات زاد طوله عن الحد المسموح له',//'微博内容超过了长度限制',
	'weibo_account_not_signup'	=> 'عذراً, لا يمكنك الوصول الى حساب تدويناتك, لا يمكنك نشر المحتوى, <a href=http://t.qq.com/reg/index.php target=_blank>اضغط هنا للوصول الان</a>.',//'抱歉，您还未开通微博账号，无法分享内容，<a href=http://t.qq.com/reg/index.php target=_blank>点击这里马上开通</a>。',
