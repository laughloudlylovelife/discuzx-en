...
(
	...
	'activity_replenish'	=> 'الفعالية  <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>, التي بدأها {actor}, ابلغك الى تحسين معلومات  تسجيل الفعالية . &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">عرض &rsaquo;</a> <div class="quote"><blockquote>{reason}</blockquote></div>',
