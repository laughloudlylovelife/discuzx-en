...
function showprovince(provinceid, cityid, province, boxid) {
	var provinces = new Array(
		"Overseas", "Beijing", "Shanghai", "Chongqing", "Anhui", "Fujian", "Gansu", "Guangdong", "Guangxi", "Guizhou", "Hainan", "Hebei", "Heilongjiang", "Henan",
		"Hong Kong", "Hubei", "Hunan", "Jiangsu", "Jiangxi", "Jilin", "Liaoning", "Macao", "Inner Mongolia", "Ningxia", "Qinghai", "Shandong",
		"Shanxi", "Shaanxi", "Sichuan", "Taiwan", "Tianjin", "Xinjiang", "Tibet", "Yunnan", "Zhejiang"
	);
