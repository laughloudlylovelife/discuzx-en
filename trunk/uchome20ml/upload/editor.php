...
//vot: Load common functions an language files
...
//vot  !!! CHECK FOR PROPER ENCODING !!!!!!!!!!!!!!
//vot  !!! May be ENABLE for windows-1251 ???????????
...
<title>Editor</title>
<!-- //vot: language added -->
<script language="javascript" type="text/javascript" src="language/<?php echo $_SCONFIG['language']; ?>/lang_js.js"></script>
...
<a href="javascript:;" class="icoSwitchMdi" title="<?php echo lang('wysiwyg'); ?>" onClick="changeEditType(true);return false;"></a>
</div>
</div>
</td></tr></table>
</td></tr></table>
...
<!--Media status toolbar-->
<div class="toobar">
<div class="icons tble">
<a href="javascript:;" class="icoCut" title="<?php echo lang('cut'); ?>" onClick="format('Cut');return false;"></a>
<a href="javascript:;" class="icoCpy" title="<?php echo lang('copy'); ?>" onClick="format('Copy');return false;"></a>
<a href="javascript:;" class="icoPse" title="<?php echo lang('paste'); ?>" onClick="format('Paste');return false;"></a>
<div class="sepline"></div>
<a href="javascript:;" class="icoFfm" id="imgFontface" title="<?php echo lang('font'); ?>" onClick="fGetEv(event);fDisplayElement('fontface','');return false;"></a>
<a href="javascript:;" class="icoFsz" id="imgFontsize" title="<?php echo lang('font_size'); ?>" onClick="fGetEv(event);fDisplayElement('fontsize','');return false;"></a>
<a href="javascript:;" class="icoWgt" onClick="format('Bold');return false;" title="<?php echo lang('bold'); ?>"></a>
<a href="javascript:;" class="icoIta" title="<?php echo lang('italic'); ?>" onClick="format('Italic');return false;"></a>
<a href="javascript:;" class="icoUln" onClick="format('Underline');return false;" title="<?php echo lang('underline'); ?>"></a>
<a href="javascript:;" class="icoFcl" title="<?php echo lang('font_color'); ?>" onClick="foreColor(event);return false;" id="imgFontColor"></a>
<a href="javascript:;" class="icoAgn" id="imgAlign" onClick="fGetEv(event);fDisplayElement('divAlign','');return false;" title="<?php echo lang('align'); ?>"></a>
<a href="javascript:;" class="icoLst" id="imgList" onClick="fGetEv(event);fDisplayElement('divList','');return false;"title="<?php echo lang('list'); ?>"></a>
<a href="javascript:;" class="icoOdt" id="imgInOut" onClick="fGetEv(event);fDisplayElement('divInOut','');return false;" title="<?php echo lang('indent'); ?>"></a>
<div class="sepline"></div>
<a href="javascript:;" class="icoUrl" id="icoUrl" onClick="createLink(event, 1);return false;" title="<?php echo lang('link_add'); ?>"></a>
<a href="javascript:;" class="icoMoveUrl" onClick="clearLink();return false;" title="<?php echo lang('link_del'); ?>"></a>
<a href="javascript:;" class="icoImg" id="icoImg" onClick="createImg(event, 1);return false;" title="<?php echo lang('image_link'); ?>"></a>
<a href="javascript:;" class="icoSwf" id="icoSwf" onClick="createFlash(event, 1);return false;" title="<?php echo lang('flash_link'); ?>"></a>
<a href="javascript:;" class="icoFace" id="faceBox" onClick="faceBox(event);return false;" title="<?php echo lang('emoticons'); ?>"></a>
<?php if($doodle) { ?>
<a href="javascript:;" class="icoDoodle" id="doodleBox" onClick="doodleBox(event, this.id);return false;" title="<?php echo lang('graffiti'); ?>"></a>
<?php }?>
<a href="javascript:;" class="icoRenew" onClick="renewContent();return false;" title="<?php echo lang('content_restore'); ?>"></a>
<?php if($allowhtml) {?>
...
<a href="javascript:;" class="icoSwitchTxt" title="<?php echo lang('plain_text'); ?>" onClick="changeEditType(false, event);return false;"></a>
</div>
</div>
...
<div class="icons tble">
<a href="javascript:;" class="icoSwitchMdi" title="<?php echo lang('wysiwyg'); ?>" onClick="changeEditType(true, event);return false;"></a>
</div>
</div>
</td>
</tr>
...
<!--
<a href="javascript:void(0)" onClick="fontname(this)" class="n" style="font:normal 12px '宋体';">宋体</a><!--Times New Roman-->
<a href="javascript:void(0)" onClick="fontname(this)" class="n" style="font:normal 12px '黑体';">黑体</a><!--Bold-->
<a href="javascript:void(0)" onClick="fontname(this)" class="n" style="font:normal 12px '楷体_GB2312';">楷体_GB2312</a><!--Italics_GB2312-->
<a href="javascript:void(0)" onClick="fontname(this)" class="n" style="font:normal 12px '隶书';">隶书</a><!--Clerical-->
<a href="javascript:void(0)" onClick="fontname(this)" class="n" style="font:normal 12px '幼圆';">幼圆</a><!--Immature rounded-->
-->
...
<a href="javascript:void(0)" onClick="fontsize(1,this)" class="n" style="font-size:xx-small;line-height:120%;"><?php echo lang('xx_small'); ?></a>
<a href="javascript:void(0)" onClick="fontsize(2,this)" class="n" style="font-size:x-small;line-height:120%;"><?php echo lang('x_small'); ?></a>
<a href="javascript:void(0)" onClick="fontsize(3,this)" class="n" style="font-size:small;line-height:120%;"><?php echo lang('small'); ?></a>
<a href="javascript:void(0)" onClick="fontsize(4,this)" class="n" style="font-size:medium;line-height:120%;"><?php echo lang('medium'); ?></a>
<a href="javascript:void(0)" onClick="fontsize(5,this)" class="n" style="font-size:large;line-height:120%;"><?php echo lang('large'); ?></a>
</div>

<div id="divList" class="eMenu" style="display:none;top:35px;left:26px;width:60px;height:40px;"><a href="javascript:void(0)" onClick="format('Insertorderedlist');fHide(this.parentNode)" class="n"><?php echo lang('list_numbered'); ?></a><a href="javascript:void(0)" onClick="format('Insertunorderedlist');fHide(this.parentNode)" class="n"><?php echo lang('list_symbolic'); ?></a></div>
<div id="divAlign" class="eMenu" style="display:none;top:35px;left:26px;width:60px;height:60px;"><a href="javascript:void(0)" onClick="format('Justifyleft');fHide(this.parentNode)" class="n"><?php echo lang('align_left'); ?></a><a href="javascript:void(0)" onClick="format('Justifycenter');fHide(this.parentNode)" class="n"><?php echo lang('align_center'); ?></a><a href="javascript:void(0)" onClick="format('Justifyright');fHide(this.parentNode)" class="n"><?php echo lang('align_right'); ?></a></div>
<div id="divInOut" class="eMenu" style="display:none;top:35px;left:26px;width:60px;height:40px;"><a href="javascript:void(0)" onClick="format('Indent');fHide(this.parentNode)" class="n"><?php echo lang('indent_add'); ?></a><a href="javascript:void(0)" onClick="format('Outdent');fHide(this.parentNode)" class="n"><?php echo lang('indent_del'); ?></a></div>

<div id="dvForeColor" class="eMenu" style="display:none;top:35px;left:26px;width:90px;">
<a href="javascript:void(0)" onClick="format(gSetColorType,'#800000')" class="n cs fRd1"><b class="cb"></b><span><?php echo lang('dark_red'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#800080')" class="n cs fRd2"><b class="cb"></b><span><?php echo lang('purple'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#F00000')" class="n cs fRd3"><b class="cb"></b><span><?php echo lang('red'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#F000F0')" class="n cs fRd4"><b class="cb"></b><span><?php echo lang('bright_pink'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#000080')" class="n cs fBu1"><b class="cb"></b><span><?php echo lang('dark_blue'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#0000F0')" class="n cs fBu2"><b class="cb"></b><span><?php echo lang('blue'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#00F0F0')" class="n cs fBu3"><b class="cb"></b><span><?php echo lang('lake_blue'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#008080')" class="n cs fGn1"><b class="cb"></b><span><?php echo lang('blue_green'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#008000')" class="n cs fGn2"><b class="cb"></b><span><?php echo lang('green'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#808000')" class="n cs fGn3"><b class="cb"></b><span><?php echo lang('olive'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#00F000')" class="n cs fGn4"><b class="cb"></b><span><?php echo lang('light_green'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#F0C000')" class="n cs fYl1"><b class="cb"></b><span><?php echo lang('orange'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#000000')" class="n cs fBk1"><b class="cb"></b><span><?php echo lang('black'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#808080')" class="n cs fBk2"><b class="cb"></b><span><?php echo lang('gray'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#C0C0C0')" class="n cs fBk3"><b class="cb"></b><span><?php echo lang('silver'); ?></span></a>
<a href="javascript:void(0)" onClick="format(gSetColorType,'#FFFFFF')" class="n cs fWt0"><b class="cb"></b><span><?php echo lang('white'); ?></span></a>
</div>
...
<div id="createUrl" class="eMenu" style="display:none;top:35px;left:26px;width:300px;font-size:12px">
	<?php echo lang('enter_link'); ?>:<br/>
	<input type="text" id="insertUrl" name="url" value="http://" class="t_input" style="width: 190px;"> <input type="button" onclick="createLink();" name="createURL" value="<?php echo lang('form_sure_yes'); ?>" class="submit" /> <a href="javascript:;" onclick="fHide($('createUrl'));"><?php echo lang('cancel'); ?></a>
</div>
<div id="createImg" class="eMenu" style="display:none;top:35px;left:26px;width:300px;font-size:12px">
	<?php echo lang('enter_image_url'); ?>:<br/>
	<input type="text" id="imgUrl" name="imgUrl" value="http://" class="t_input" style="width: 190px;" /> <input type="button" onclick="createImg();" name="createURL" value="<?php echo lang('form_sure_yes'); ?>" class="submit" /> <a href="javascript:;" onclick="fHide($('createImg'));"><?php echo lang('cancel'); ?></a>
</div>
<div id="createSwf" class="eMenu" style="display:none;top:35px;left:26px;width:400px;font-size:12px">
	<?php echo lang('enter_video_url'); ?>:<br/>
	<select name="vtype" id="vtype">
		<option value="0"><?php echo lang('flash_animation'); ?></option>
		<option value="1"><?php echo lang('media_video'); ?></option>
		<option value="2"><?php echo lang('real_video'); ?></option>
	</select>
	<input type="text" id="videoUrl" name="videoUrl" value="http://"  class="t_input" style="width: 200px;" />
	<input type="button" onclick="createFlash();" name="createURL" value="<?php echo lang('form_sure_yes'); ?>" class="submit" />
	<a href="javascript:;" onclick="fHide($('createSwf'));"><?php echo lang('cancel'); ?></a>
</div>
