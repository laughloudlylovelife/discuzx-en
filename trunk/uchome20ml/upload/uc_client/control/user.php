...
class usercontrol extends base {
	...
	//note public 外部接口  registration 校验接口
	function onregister() {
		$this->init_input();
	...
	//note public 外部接口 ajax 校验 user  name 
	...
	//note public 外部接口 flash mode 裁剪头像 COOKIE 判断身份
