...
// MANYOU settings
$my_url = 'http://api.manyou.com/uchome.php';//App Settings page
$my_register_url = 'http://api.manyou.com/uchome.php';//Registration API

$_SC['language'] = $_SC['language'] ? $_SC['language'] : 'en';//'zh_CN'
...
if(submitcheck('mysubmit')) {
	...
	//If App service is off and on the interface directly calls the update
...
// application platform registration update 
