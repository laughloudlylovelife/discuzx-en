...
(
	...
	'share_album'		=> '{actor} قام بنشر البومك <a href="{url}" target="_blank">{albumname}</a>.',//'{actor} 分享了你的相册 <a href="{url}" target="_blank">{albumname}</a>',
	'share_pic'		=> '{actor} قام بنشر البومك <a href="{url}" target="_blank">{albumname}</a>.',//'{actor} 分享了你的相册 {albumname} 中的 <a href="{url}" target="_blank"> 图片</a>',
	...
	'magic_present_note'	=> ' قدم لك دعامة  <a href="{url}" target="_blank">{name}</a>.',//'送给你一个道具 <a href="{url}" target="_blank">{name}</a>',
	'friend_add'		=> '{actor} وانت اصبحتما اصدقاء.',//'{actor} 和你成为了好友',
	...
	'group_member_join'	=> '{actor} يريد الانضمام الى مجموعتك, الرجاء اخذ الاجراء المناسب  <a href="{url}" target="_blank">من لوحة ادارة المجموعة</a>',//'{actor} 加入你的群组需要审核，请到群组 <a href="{url}" target="_blank">管理后台</a> 进行审核',
	'group_member_invite'	=> '{actor} قام بدعوتك للانضمام الى مجموعة  <a href="forum.php?mod=group&fid={fid}" target="_blank">{groupname}</a>, <a href="{url}" target="_blank">اضغط هنا للانضمام الان</a>',//'{actor} 邀请你加入 <a href="forum.php?mod=group&fid={fid}" target="_blank">{groupname}</a> 群组，<a href="{url}" target="_blank">点此马上加入</a>',
	'group_member_check'	=> 'طلبك في الانضمام الى  <a href="{url}" target="_blank">{groupname}</a> تم قبوله, please <a href="{url}" target="_blank">اضغط هنا لزيارة المجموعة</a>',//'你已经通过了 <a href="{url}" target="_blank">{groupname}</a> 群组的审核，请 <a href="{url}" target="_blank">点击访问</a>',
	...
	'reason_stamp_update'	=> 'موضوعك <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> تم اضافة له ختم  {stamp} بواسطة {actor} <div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 添加了图章 {stamp} <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'modthreads_validate'	=> 'موضوعك <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{threadsubject}</a> تم الموافقة عليه! &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">اضغط هنا لرؤيته;</a> <div class="quote"><blockquote>{reason}</blockquote></div>',//'你发表的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{threadsubject}</a> 已经审核通过！ &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a> <div class="quote"><blockquote>{reason}</blockquote></div>',
...
<p class="summary">رقم الطلبية: <span>{orderid}</span></p><p class="summary">الدفع: <span>{price} دولار </span></p><p class="summary">النقاط الواردة : <span>{value}</span></p>',
	...
	'activity_notice'	=> '{actor} قما بالانضمام الى  <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>, الرجاء  &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">عرضها</a>',//'{actor} 申请加入你举办的活动 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>，请审核 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',

	'activity_apply'	=> 'الفعالية  <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> التي بدءها "{actor}" قام بالموافقة على اشتراكك بها  &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">عرضها</a> <div class="quote"><blockquote>{reason}</blockquote></div>',//'活动 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的发起人 {actor} 已批准你参加此活动 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a> <div class="quote"><blockquote>{reason}</blockquote></div>',

	'activity_replenish'	=> 'الفعالية  <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>, التي بدءها {actor}, ابلغك الى تحسين معلومات  تسجيل الفعالية . &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">عرض &rsaquo;</a> <div class="quote"><blockquote>{reason}</blockquote></div>',

	'activity_delete'	=> 'الفعالية  <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> منظمها "{actor}" قام برفض انضمامك للفعالية  &nbsp; <a href="forum.php?mod=viewthread&tid={tid}"  target="_blank" class="lit">عرضها</a> <div class="quote"><blockquote>{reason}</blockquote></div>',

	'activity_cancel'	=> '{actor} قام بالغاء اشتراكك في  <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> . &nbsp; <a href="forum.php?mod=viewthread&tid={tid}"  target="_blank" class="lit">عرض &rsaquo;</a> <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'reward_question'	=> 'موضوع طلبك <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> تم اختيار افضل اجابة له  بواسطة {actor} &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">عرضها</a>',//'你的悬赏主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 设置了最佳答案 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',

	'reward_bestanswer'	=> 'ردك في موضوع طلب  <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> تم اختياره كأفضل اجابة بواسطة الكاتب وهو  {actor} &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">عرضها</a>',//'你的回复被的悬赏主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的作者 {actor} 选为悬赏最佳答案 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',
	...
	'task_reward_group'	=> 'تهانينا! لقد اكملت مهمتك : <a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>,ووصلت الى مجموعة  {rewardtext}. صالح حتى : {bonus} يوم. &nbsp; <a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank" class="lit">عرض صلاحياتي</a>',//'恭喜你完成任务：<a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>，获得用户组 {rewardtext} 有效期 {bonus} 天 &nbsp; <a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank" class="lit">看看我能做什么 &rsaquo;</a>',

	'user_usergroup'	=> 'تم ترقية مجموعة الاعضاء الخاصة بك الى  {usergroup}. &nbsp; <a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank" class="lit">عرض صلاحياتي</a>',//'你的用户组升级为 {usergroup} &nbsp; <a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank" class="lit">看看我能做什么 &rsaquo;</a>',

	'grouplevel_update'	=> 'تهانينا! مجموعتك {groupname} تم ترقية مستواها الى  {newlevel}.',//'恭喜你，你的群组 {groupname} 已经升级到了 {newlevel}。',

	'thread_invite'		=> '{actor} قام بدعوتك الى  {invitename}  <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>. &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">عرض</a>',//'{actor} 邀请你{invitename} <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',
	'invite_friend'		=> 'تهانينا! لقد تم دعوتك من طرف  {actor} واصبحتما اصدقاء.',//'恭喜你成功邀请到 {actor} 并成为你的好友',
	...
	'member_moderate_invalidate'		=> 'تم رفض حسابك من قبل المدير , الرجاء  <a href="home.php?mod=spacecp&ac=profile">اعادة تقديم معلومات التسجيل مرة اخرى </a>.<br />ملاحظة المدير: <b>{remark}</b>',//'你的账号未能通过管理员的审核，请<a href="home.php?mod=spacecp&ac=profile">重新提交注册信息</a>。<br />管理员留言: <b>{remark}</b>',
...
<p class="mbn"><a href="home.php?mod=magic" target="_blank">رجوع</a><span class="pipe">|</span><a href="home.php?mod=magic&action=mybox" target="_blank">عرض الدعائم الخاصة بي</a></p>',
