...
(
	...
	'attachmentlist_desc'			=> 'اظهار قائمة المرفقات',//'论坛附件列表调用',
	...
	'attachmentlist_threadmethod_comment'	=> 'ضع &quot;نعم&quot; لاظهار المرفقات في وضع موضوع (في كل موضوع مرفق واحد), او &quot;لا&quot; لاظهار المرفقات في وضع المرفقات.',//'选择“是”将按照主题方式调用附件，一个主题显示一个附件；选择“否”将按照附件方式调用',
	...
	'attachmentlist_special_1'		=> 'موضوع استطلاع',//'投票主题',
	...
	'attachmentlist_special_reward_1'		=> 'انتهى',//'已解决',
...
//	'attachmentlist_orderby_weekdownloads'		=> 'تحميلات اخر اسبوع',//'按本周下载次数倒序排序',
//	'attachmentlist_orderby_monthdownloads'	=> 'تحميلات اخر شهر',//'按当月下载次数倒序排序',
