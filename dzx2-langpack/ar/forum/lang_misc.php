...
(
	...
	'post_banned'		=> '**** الكاتب محظور او محذوف ****',//'**** 作者被禁止或删除 内容自动屏蔽 ****',
	...
	'post_reply'		=> 'رد',//'回复',
	'post_thread'		=> 'اضافة موضوع',//'的帖子',

	'price'	=> 'السعر',
	'pay_view'	=> 'Record',  //销售记录
	'attachment_buy'	=> 'شراء',
	...
	'post_deleted'	=> 'محذوف',
	'postappend_content'		=> 'اضافة مشاركة',//'补充内容',
	'payment_unit'			=> ' وحدة ',//'元',

	'attach'			=> 'المرفقات',//'附件',
	'attach_pay'			=> 'المرفقات المدفوعة',//'收费附件',
	'attach_credits_policy'		=> 'عرض سياسة البيع',//'查看积分策略说明',
	'attach_img'			=> 'ارفاق صور',//'图片附件',
	'attach_readperm'		=> 'قراءة الصلاحيات',//'阅读权限',
	'attach_img_zoom'		=> 'اضغط لعرض الصورة بالحجم الكامل في نافذة جديدة.\\n CTRL + عجلة الماوس للتقريب او التبعيد.',//'点击在新窗口查看全图\\nCTRL+鼠标滚轮放大或缩小',
	'attach_img_thumb'		=> 'اضغط هنا لعرض الصورة بالحجم الكامل',//'点击在新窗口查看全图',
	...
	'trade_waitselleragree'		=> 'انتظر لموافقة البائع على اعادة الاموال',//'等待卖家同意退款',
	'trade_sellerrefusebuyer'	=> 'البائع رفض شروط المشتري, انتظر لمشتري اخر',//'卖家拒绝买家条件，等待买家修改条件',
	'trade_waitbuyerreturn'		=> 'البائع وافق على اعادة الاموال, الانتظار لرجوع المنتج الى البائع',//'卖家同意退款，等待买家退货',
	'trade_waitsellerconfirmgoods'	=> 'الانتظار لاستقبال البائع منتجاته',//'等待卖家收货',
	...
	'trade_overedrefund'		=> 'اعادة الاموال اكتمل',//'结束的退款',
	...
	'credit_payment'		=> 'اعادة شحن/تعبئة النقاط',//'积分充值',
	'credit_forum_payment'		=> 'اعادة شحن/تعبئة نقاط المنتدى',//'论坛积分充值',
	...
	'formulaperm_regday'		=> 'ايام بعد التسجيل',//'注册天数',
	'formulaperm_regip'		=> 'التسجيل IP',//'注册IP',
	'formulaperm_lastip'		=> 'اخر اي بي',//'最后登录IP',
	...
	'modcp_logs_action_moderate'		=> 'اشراف',//'审核',
	'modcp_logs_action_member'		=> 'تعديل عضو',//'用户管理',
	'modcp_logs_action_forumaccess'		=> 'صلاحيات العضو',//'用户权限',
	'modcp_logs_action_thread'		=> 'ادارة المواضيع',//'主题管理',
	'modcp_logs_action_forum'		=> 'ادار الاقسام',//'版块管理',
	'modcp_logs_action_announcement'	=> 'الاعلانات',//'公告',
	'modcp_logs_action_log'			=> 'ادارة المدونات',//'管理日志',
	'modcp_logs_action_stat'		=> 'احصائيات المشرفين',//'管理统计',

	'modcp_logs_action_login'	=> 'تسجيل الدخول',//'登录',

	'uch_selectalbum'		=> 'اختيار الالبوم',//'请选择相册',
	'uch_noalbum'			=> 'انت لا تملك اي البوم, ',//'您还没有相册，',
	'click_here'			=> 'اضغط هنا',//'点击这里',
	'uch_createalbum'		=> ' انشاء البوم جديد!',//'创建自己的相册吧！',

	'pm_from'		=> ' من ',//'发件人',
	'pm_to'			=> ' الى ',//'收件人',
	'pm_date'		=> ' التاريخ ',//'日期',

	'share_message'		=> 'السلام عليكم! لقد رأيت هذا الموضوع في  {$_G[setting][bbname]}, اعتقد انه مفيد, لذلك انصحك به.\\n\\nTitle: $thread[subject]\\nالوصلة: [url={$threadurl}]{$threadurl}[/url]\\n\\n اتمنى ان يعجبك .',
	...
	'notice_actor'		=> ', و لذا في الاجمالي: $actorcount شخص',//'等 $actorcount 人',
	
	'perms_allowvisit'	=> 'الوصول للاقسام',//'访问论坛',
	'perms_readaccess'	=> 'صلاحيات القراءة',//'阅读权限',
	'perms_allowviewpro'	=> 'عرض معلومات الاعضاء',//'查看用户资料',
	'perms_allowinvisible'	=> 'وضع التخفي',//'隐身',
	'perms_allowsearch'	=> 'استخدام البحث',//'使用搜索',
	'perms_allownickname'	=> 'السماح باستخدام اسم ظاهري',//'使用昵称',
	'perms_allowcstatus'	=> 'حالات مخصصة',//'自定义头衔',
	'perms_allowpost'	=> 'اضافة موضوع',//'发新话题',
	'perms_allowreply'	=> 'اضافة رد',//'发表回复',
	'perms_allowpostpoll'	=> 'اضافة استطلاع',//'发起投票',
	'perms_allowvote'	=> 'تصويت',//'参与投票',
	'perms_allowpostreward'		=> 'اضافة طلب',//'发表悬赏',
	'perms_allowpostactivity'	=> 'اضافة فعالية',//'发表活动',
	'perms_allowpostdebate'		=> 'اضافة مناقشة',//'发表辩论',
	'perms_allowposttrade'		=> 'اضافة منتج',//'发表交易',
	'perms_maxsigsize'		=> 'الطول الاقصى للتوقيع',//'最大签名长度',
	'perms_allowsigbbcode'		=> 'استخدام BBCode في التوقيع',//'签名中使用 Discuz! 代码',
	'perms_allowsigimgcode'		=> 'استخدام [img]  في التوقيع',//'签名中使用 [img] 代码',
	'perms_maxbiosize'		=> 'اقصى طول للنبذة الشخصية',//'自我介绍最大长度',
	'perms_allowrecommend'		=> 'اضافة موضوع مستحسن',//'主题评价影响值',
	'perms_allowbiobbcode'		=> 'استخدام BBCode في النبذة',//'自我介绍中使用 Discuz! 代码',
	'perms_allowbioimgcode'		=> 'استخدام [img] في النبذة',//'自我介绍中使用 [img] 代码',
	...
	'perms_allowrecommendthread'	=> 'اضافة كمستحسن',//'主题推荐',
	'perms_allowstampthread'	=> 'اضافة ختم',//'主题鉴定',
	...
	'perms_alloweditpoll'		=> 'تعديل استطلاع',//'编辑投票',
	...
	'perms_allowmodpost'		=> 'ادارة المشاركات',//'审核帖子',
	'perms_allowmoduser'		=> 'ادارة الاعضاء',//'审核用户',
	'perms_allowbanuser'		=> 'حظر عضو',//'禁止用户',
	'perms_allowbanip'		=> 'حظر اي بي',//'禁止 IP',
	'perms_allowedituser'		=> 'تعديل عضو',//'编辑用户',
	'perms_allowmassprune'		=> 'حذف موضوع/مشاركة',//'批量删帖',
	'perms_allowpostannounce'	=> 'اضافة اعلان',//'发布公告',
	'perms_disablepostctrl'		=> 'غير مقيد',//'发帖不受限制',
	'perms_allowviewip'		=> 'مشاهدة اي بي',//'允许查看 IP',
	'perms_viewperm'		=> 'مشاهدة قسم',//'浏览版块',
	'perms_postperm'		=> 'اضافة موضوع',//'发新话题',
	'perms_replyperm'		=> 'اضافة رد',//'发表回复',
	...
	'perms_allowdoing'		=> 'اضافة افعال',//'发表记录',
	'perms_allowupload'		=> 'رفع صورة',//'上传图片',
	'perms_allowshare'		=> 'منشورات',//'发布分享',
	'perms_allowpoke'		=> 'ارسال تحية',//'允许打招呼',
	'perms_allowfriend'		=> 'اضافة صديق',//'允许加好友',
	'perms_allowclick'		=> 'تقييم',//'允许表态',
	'perms_allowmyop'		=> 'استخدام تطبيقات',//'允许使用应用',
	'perms_allowcomment'		=> 'نشر تعليق',//'发表留言/评论',
	'perms_allowstatdata'		=> 'عرض تقارير بيانات الإحصائية',//'查看统计数据报表',
	'perms_allowstat'		=> 'مشاهدة الاحصائيات',//'允许查看趋势统计',
	'perms_allowpostarticle'	=> 'نشر مقالات',
	'perms_raterange'	=> 'السماح بالتقييمات',
	'perms_allowsendpm'	=> 'السماح بارسال رسالة',
	'perms_maximagesize'	=> 'الحد الاقصى من حجم الصورة الواحدة',
	'perms_allowmediacode'	=> 'السماح باستخدام رمز الوسائط المتعددة',

	'join_topic'		=> 'انضمام في موضوع',//'参与话题',
	'join_poll'		=> 'تصويت في استطلاع',//'参与投票',
	'buy_trade'		=> 'بيع منتج',//'购买商品',
	'join_reward'		=> 'الاجابة على طلب',//'参与悬赏',
	'join_activity'		=> 'الاشتراك في فعالية',//'参与活动',
	'join_debate'		=> 'الاشتراك في التحدي',//'参与辩论',
