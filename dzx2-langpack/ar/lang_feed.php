...
(
	...
	'feed_album_title'	=> '{actor} حدث البوم',//'{actor} ?????',
	'feed_album_body'	=> '<b>{album}</b><br /> اجمالي الصور : {picnum}',//'<b>{album}</b><br />? {picnum} ???',
	'feed_pic_title'	=> '{actor} قام برفع صورة جديدة',//'{actor} ??????',
	'feed_pic_body'		=> '{title}',



	'feed_poll'		=> '{actor} قام بانشاء استطلاع جديد',//'{actor} ??????',
	...
	'feed_showcredit'	=> '{actor} قدم  {credit} نقطة لـ {fusername} للظهور في  <a href="home.php?mod=space&do=top">اعلى القائمة</a>',//'{actor} ??? {fusername} ???? {credit} ?,???????<a href="home.php?mod=space&do=top" target="_blank">?????</a>????',
	'feed_showcredit_self'	=> '{actor} انفق {credit} نقطة لظهور نفسه <a href="home.php?mod=space&do=top">اعلى القائمة</a>',//'{actor} ?????? {credit} ?,?????<a href="home.php?mod=space&do=top" target="_blank">?????</a>????',
	'feed_doing_title'	=> '{actor} يقول: {message}',//'{actor}:{message}',
	'feed_friend_title'	=> '{actor} و {touser} أصبحا اصدقاء',//'{actor} ? {touser} ?????',



	'feed_click_blog'	=> '{actor} ارسل  &quot;{click}&quot; الى  مدونة {touser}  ({subject})',//'{actor} ????“{click}”? {touser} ??? {subject}',
	'feed_click_thread'	=> '{actor} ارسل &quot;{click}&quot; الى موضوع {touser}  ({subject})',//'{actor} ????“{click}”? {touser} ??? {subject}',
	'feed_click_pic'	=> '{actor} ارسل &quot;{click}&quot; الى صورة  {touser} ',//'{actor} ????“{click}”? {touser} ???',
	'feed_click_article'	=> '{actor} ارسل &quot;{click}&quot; الى مقالة  {touser}  ({subject}*',//'{actor} ????“{click}”? {touser} ??? {subject}',
	...
	'feed_add_attachsize'		=> '{actor} انفق {credit} نقطة لتوسيع حجم ملفه الشخصي  ({size}). ويمكنه الان رفع بيانات اكثر. (<a href="home.php?mod=spacecp&ac=credit&op=addsize">انا اريد ذلك ايضا!</a>)',//'{actor} ? {credit} ?????? {size} ????,??????????(<a href="home.php?mod=spacecp&ac=credit&op=addsize">?????</a>)',

	'feed_invite'			=> '{actor} دعا {username}, ولقد اصبحا اصدقاء',//'{actor} ????,? {username} ?????',
	...
	'feed_thread_poll_title'	=>		'{actor} قام بانشاء استطلاع',//'{actor} ??????',
