...
(
	...
	'member_complete_var_act_favorite'	=> 'Добавить тему в избранное',
	'member_complete_var_act_magic'		=> 'Использовать магию',
	'member_complete_var_num'		=> 'Минимальное количество выполнений',
	'member_complete_var_num_comment'	=> 'Пользователи должны выполнить указанное действие как минимум указанное количество раз.',
