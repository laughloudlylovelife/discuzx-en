...
//	'cancel'		: 'Cancel',//'取消',
	...
	'page_prev'		: 'Пред.',//'上页',
	'page_next'		: 'След.',//'下页',
	'copy2clipboard'	: 'Копировать в карман',//'点此复制到剪贴板',
	...
	'code_clipboard'	: 'Данные скопированы в карман',//'代码已复制到剪贴板',
...
//	'code_invalid'			: 'Wrong security code, please try again',//'验证码错误，请重新填写',
	...
	'content_overwrite'	: 'Текущий контент темы будет перезаписан ранее сохранёнными данными! Вы уверены, что хотите восстановить сохранённый контент?',//'此操作将覆盖当前帖子内容，确定要恢复数据吗？',
...
//	'credit_confirm1'	: 'This costs ',//'下载积分将',
	...
	'thread_to_clipboard'	: 'URL темы скопирован в карман',//'帖子地址已经复制到剪贴板',
...
//static/js/register.js
	...
	'username_short'	: 'Имя пользователя не должно быть короче 3х символов',//'用户名小于 3 个字符',
