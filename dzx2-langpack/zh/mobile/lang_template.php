...
$lang = array (
  ...
  'attach_nopermission_login' => '您需要<a href="member.php?mod=logging&action=login">登录</a>才可以下载或查看附件。没有帐号？<a href="member.php?mod={$_G[setting][regname]}" title="注册帐号">注册</a>',
  'attachlist' => '附件列表',
  'ban_member' => '禁止',
