...
define('UC_CLIENT_VERSION', '1.5.0');	//note UCenter version of the logo
define('UC_CLIENT_RELEASE', '20081031');

define('API_DELETEUSER', 1);		//note API user delete
define('API_RENAMEUSER', 1);		//note API user rename
define('API_GETTAG', 1);		//note API get TAG
define('API_SYNLOGIN', 1);		//note API synchronous login
define('API_SYNLOGOUT', 1);		//note API Synchronous logout
define('API_UPDATEPW', 1);		//note Update user password
define('API_UPDATEBADWORDS', 1);	//note Update badword list
define('API_UPDATEHOSTS', 1);		//note Update domain names
define('API_UPDATEAPPS', 1);		//note Update application list
define('API_UPDATECLIENT', 1);		//note Update client cache
define('API_UPDATECREDIT', 1);		//note Update User Points
define('API_GETCREDITSETTINGS', 1);	//note Get UCenter Points settings
define('API_GETCREDIT', 1);		//note Get users points
define('API_UPDATECREDITSETTINGS', 1);	//note Update points settings

define('API_RETURN_SUCCEED', '1');
define('API_RETURN_FAILED', '-1');
define('API_RETURN_FORBIDDEN', '-2');

//http notice the ordinary way of note
if(!defined('IN_UC')) {
...
//note include Notification method
} else {
...
class uc_note {
	...
	function deleteuser($get, $post) {
		...
		//note API interface to user delete
		$threads = array();
	...
	function synlogin($get, $post) {
		...
		//note Synchronous login API Interface
		require $this->dbconfig;
		require_once $this->appdir.'./include/db_'.$database.'.class.php';
		require_once $this->appdir.'./forumdata/cache/cache_settings.php';
	...
	function synlogout($get, $post) {
		...
		//note Synchronization login API
		header('P3P: CP="CURa ADMa DEVa PSAo PSDo OUR BUS UNI PUR INT DEM STA PRE COM NAV OTC NOI DSP COR"');
	...
	function updateapps($get, $post) {
		...
		//note Write configuration files
...
//note Require before using the function: require_once $this->appdir.'./config.inc.php';
