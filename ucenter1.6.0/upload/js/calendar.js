...
function loadcalendar() {
	...
	s += '<th><a href="###" onclick="refreshcalendar(yy, mm-1)" title="'+lng['prev_month']+'">&laquo;</a></th>';
	s += '<th colspan="5" style="text-align: center"><a href="###" onclick="showdiv(\'year\');_cancelBubble(event)" title="'+lng['select_year']+'" id="year"></a>&nbsp; - &nbsp;<a id="month" title="'+lng['select_month']+'" href="###" onclick="showdiv(\'month\');_cancelBubble(event)"></a></th>';
	s += '<th><A href="###" onclick="refreshcalendar(yy, mm+1)" title="'+lng['next_month']+'">&raquo;</A></th>';
	s += '</tr>';
